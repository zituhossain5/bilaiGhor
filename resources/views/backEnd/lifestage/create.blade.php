...
<div class="container-fluid">
    ...
    <form action="{{route('lifestages.store')}}" method="POST" data-parsley-validate>
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" placeholder="e.g. e.g. Adult, Kitten, Senior" required>
