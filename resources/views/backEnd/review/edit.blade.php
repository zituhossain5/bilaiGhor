                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control select2" name="ratting" required>
                                ...
                                <option value="2" {{$edit_data->ratting == 2 ? 'selected' : ''}}>⭐⭐ (2 Stars)</option>
                                <option value="1" {{$edit_data->ratting == 1 ? 'selected' : ''}}>⭐ (1 Star)</option>
                            </select>
                            @error('ratting')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded border border-light">
                            ...
                            <label class="switch">
                                ...
                                <input type="checkbox" name="status" value="active" @if($edit_data->status=='active') checked @endif>
