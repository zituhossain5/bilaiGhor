                    ...
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-muted" title="{{$value->review}}">
                                        {{ Str::limit($value->review, 60) }}
                                    </span>
                                </td>
                                ...
                                <td>
                                    <div class="star-rating">
                                        @for($i = 1; $i <= 5; $i++)
                                            <i class="mdi mdi-star {{ $i <= $value->ratting ? 'filled' : '' }}"></i>
                                        @endfor
                                        <span class="ms-1 text-dark fw-bold font-size-12">({{ $value->ratting }}.0)</span>
                                    </div>
                                </td>
