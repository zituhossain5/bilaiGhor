...
@section('title','Shipping Charge Management')
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('shippingcharges.edit',$value->id) }}" class="btn-action btn-edit" title="Edit">
                                            <i class="fe-edit-1" style="font-size: 16px;"></i>
                                        </a>

                                        <form action="{{ route('shippingcharges.destroy') }}" method="POST" class="delete-form d-inline">
                                            @csrf
