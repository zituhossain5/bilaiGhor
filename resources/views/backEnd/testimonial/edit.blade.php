...
<style>
    ...
    .preview-img { max-width: 100%; max-height: 260px; object-fit: contain; border-radius: 8px; display: block; background: #f9fbfd; box-shadow: 0 4px 10px rgba(0,0,0,0.08); }
    .current-image-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; color: #8391a2; margin-bottom: 10px; }
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    ...
                    <p class="text-muted font-size-13 mb-0">Update the testimonial image and its display settings.</p>
                </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="image-upload-box" onclick="document.getElementById('image').click()">
                                ...
                                @if($testimonial->image)
                                    <div id="current_image">
                                        ...
                                        <img src="{{ asset('public/'.$testimonial->image) }}" class="preview-img" alt="Current testimonial image">
                                        <small class="text-muted d-block mt-2">Click to replace &mdash; JPG, JPEG, PNG, WEBP (Max 2MB)</small>
                                    </div>
                                @else
                                    <div id="upload_placeholder" class="upload-placeholder">
                                        <i class="fe-upload-cloud"></i>
                                        <p>Click to upload a review screenshot</p>
                                        <small class="text-muted d-block mt-1">JPG, JPEG, PNG, WEBP (Max 2MB)</small>
                                    </div>
                                @endif

                                <div id="new_preview" class="d-none">
                                    <p class="current-image-label">New image</p>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-0">
                                ...
                                <small class="text-muted d-block mt-1">Lower numbers show first.</small>
                            </div>
                        </div>
                    </div>
                </div>
