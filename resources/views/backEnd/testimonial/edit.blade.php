                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="location" class="form-control"
                                       value="{{ old('location', $testimonial->location) }}" placeholder="e.g. Dhaka, Bangladesh">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded border border-light">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="status" value="1" {{ $testimonial->status ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="image-upload-box" onclick="document.getElementById('image').click()">
                            ...
                            @if($testimonial->image)
                                <img id="preview_image" class="preview-img" src="{{ asset('public/'.$testimonial->image) }}" alt="">
