        ...
        <div class="bilai-dash-layout">
            ...
            <aside>
                <div class="bilai-dash-sidebar-card">
                    ...
                    {{-- Profile: avatar left, name/phone right --}}
            ...
            <main>
                ...
                <div class="bilai-dash-main-card">
                    <h2 class="bilai-dash-welcome-title">Welcome back, {{ ucfirst($customer->name ?? 'Customer') }}!</h2>
