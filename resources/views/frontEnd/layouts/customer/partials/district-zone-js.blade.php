{{-- ═══════════════════════════════════════════════════════════════
     Shared District → Zone behavior (Select2 + zone AJAX).
     Single source for: Add/Edit Address modal + Profile Edit.
     Loads select2 exactly once per page (@once) — never load it again elsewhere.

     API:
       BilaiDistrictZone.loadZones($zoneSelect, districtId, selectedZoneId)  -> jqXHR|undefined
       BilaiDistrictZone.initFields({ district, zone, selectedZone, dropdownParent, fresh })
════════════════════════════════════════════════════════════════ --}}
@once
@push('script')
