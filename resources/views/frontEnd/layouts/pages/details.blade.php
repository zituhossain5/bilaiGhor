                ...
                <div class="bpd-info-cards">
                    ...
                    <div class="bpd-info-card">
                        ...
                        <div>
                            ...
                            <div class="bpd-card-value">{{ $soldCount > 0 ? $soldCount . '+' : '0' }} sold in last 7 days</div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="bpd-delivery-grid">
            ...
            <div class="bpd-accordion">
                <button class="bpd-accordion-btn" onclick="bpdAccordion(this)" type="button">
                    <span class="bpd-accordion-ico">
                        {{-- ICON: Replace the SVG below with your custom delivery icon --}}
            ...
            <div class="bpd-accordion">
                <button class="bpd-accordion-btn" onclick="bpdAccordion(this)" type="button">
                    <span class="bpd-accordion-ico">
                        {{-- ICON: Replace the SVG below with your custom charges icon --}}
