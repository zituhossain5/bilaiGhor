...
<?php $__env->startSection('title', 'Scheduled tasks'); ?>
    ...
    <div class="main-content-inner">
        <div class="cron-suite-hero">
            ...
            <div class="cron-suite-meta">
                <span class="cron-pill">
                    <i class="fa fa-bolt"></i> <?php echo e($jobs->where('is_enabled', true)->count()); ?>/<?php echo e($jobs->count()); ?> সক্রিয়
                </span>
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-7 mb-4">
                ...
                <article class="cron-job-card mb-4" id="card-job-<?php echo e($job->id); ?>">
                    <header class="cron-job-head">
                        ...
                        <div class="cron-job-head-body">
                            ...
                            <p class="cron-desc"><?php echo e($job->job_description); ?></p>
                        </div>
                        <div class="cron-switch-wrap">
                            <label class="cron-switch mb-0" title="<?php echo e($job->is_enabled ? 'বন্ধ করুন' : 'চালু করুন'); ?>">
                                <input type="checkbox" class="toggle-cron" data-id="<?php echo e($job->id); ?>" <?php echo e($job->is_enabled ? 'checked' : ''); ?>>
                    ...
                    <div class="cron-job-main">
                        <div class="cron-stats">
                            <div class="cron-stat">
                                <div class="cron-stat-val ok" id="updated-<?php echo e($job->id); ?>"><?php echo e($job->last_updated_count ?? 0); ?></div>
                                <div class="cron-stat-lbl">আপডেট হয়েছে</div>
                            </div>
                            <div class="cron-stat">
                                <div class="cron-stat-val bad" id="failed-<?php echo e($job->id); ?>"><?php echo e($job->last_failed_count ?? 0); ?></div>
                                <div class="cron-stat-lbl">ব্যর্থ</div>
                            </div>
                            <div class="cron-stat">
                                <div class="cron-stat-val hl"><?php echo e($job->frequency_minutes); ?></div>
                        ...
                        <div class="cron-run-row">
                            <div>
                                ...
                                <span class="cron-last-time" id="last-run-at-<?php echo e($job->id); ?>">
                                    <?php echo e($job->last_run_at ? $job->last_run_at->format('d M Y, h:i A') : 'এখনও রান হয়নি'); ?>

                                </span>
                            </div>
                            <span class="run-badge <?php echo e($job->last_run_status ?? 'none'); ?>" id="status-badge-<?php echo e($job->id); ?>">
                        ...
                        <?php if($job->last_run_result): ?>
                        <div class="cron-result" id="result-text-<?php echo e($job->id); ?>">
                            <i class="fa fa-commenting-o"></i><?php echo e($job->last_run_result); ?>

                        </div>
                        <?php else: ?>
                        <div class="cron-result" id="result-text-<?php echo e($job->id); ?>" style="display:none;"></div>
                        <?php endif; ?>

                        <div class="cron-form-grid">
                            <div class="cron-field">
                                <label for="freq-<?php echo e($job->id); ?>">ফ্রিকোয়েন্সি</label>
                                <select class="cron-select freq-select" id="freq-<?php echo e($job->id); ?>">
                                    <?php $__currentLoopData = [1,2,5,10,15,30,60,120]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $min): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($min); ?>" <?php echo e($job->frequency_minutes == $min ? 'selected' : ''); ?>>
                                        <?php echo e($min >= 60 ? ($min/60).' ঘণ্টা' : $min.' মিনিট'); ?>
                            ...
                            <div class="cron-field">
                                <label for="limit-<?php echo e($job->id); ?>">অর্ডার লিমিট</label>
                                <select class="cron-select freq-select" id="limit-<?php echo e($job->id); ?>">
                                    <?php $__currentLoopData = [10,25,50,100,200,500]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lim); ?>" <?php echo e($job->order_limit == $lim ? 'selected' : ''); ?>>
                                        <?php echo e($lim); ?>টি
                                    </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                    ...
                    <footer class="cron-job-foot">
                        <span class="cron-foot-note">
                            ...
                            স্বয়ংক্রিয়: প্রতি <strong id="freq-display-<?php echo e($job->id); ?>"><?php echo e($job->frequency_minutes >= 60 ? ($job->frequency_minutes/60).' ঘণ্টা' : $job->frequency_minutes.' মিনিট'); ?></strong>
                        </span>
                        <button type="button" class="btn-run-now" id="btn-run-<?php echo e($job->id); ?>" data-id="<?php echo e($job->id); ?>">
            ...
            <div class="col-lg-4 col-xl-5 mb-4">
                <aside class="cron-docs">
                    ...
                    <div class="cron-code-block">
                        ...
                        <code id="cron-cmd-line">* * * * * cd <?php echo e(base_path()); ?> && php artisan schedule:run >> /dev/null 2>&1</code>
                    </div>
...
(function() {
    ...
    document.querySelectorAll('.toggle-cron').forEach(function(el) {
        el.addEventListener('change', function() {
            ...
            fetch('<?php echo e(url("admin/cron-jobs")); ?>/' + id + '/toggle', {
                method: 'POST',
    ...
    document.querySelectorAll('.btn-save-settings').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(url("admin/cron-jobs")); ?>/' + id + '/settings', {
                method: 'POST',
                headers: {
    ...
    document.querySelectorAll('.btn-run-now').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(url("admin/cron-jobs")); ?>/' + id + '/run-now', {
                method: 'POST',
                headers: { 'X-CSRF-TOKEN': csrfToken, 'Accept': 'application/json' }
            })
            .then(function(r) { return r.json(); })
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\cronjob\index.blade.php ENDPATH**/ ?>