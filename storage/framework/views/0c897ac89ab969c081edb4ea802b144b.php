...
<?php $__env->startSection('title','Edit Pixel'); ?>
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;">Edit Pixel</h4>
                <p class="text-muted font-size-13 mb-0">Update tracking pixel configuration.</p>
            </div>
            <a href="<?php echo e(route('pixels.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">Update Pixel Configuration</h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('pixels.update')); ?>" method="POST" data-parsley-validate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg <?php $__errorArgs = ['code'];
...
unset($__errorArgs, $__bag); ?>" 
                                   name="code" value="<?php echo e($edit_data->code); ?>" id="code" required>
                            
                            <small class="text-muted d-block mt-2">
                                <i class="fe-info"></i> Update your Facebook Pixel ID or Google Tag ID.
                            </small>
                        ...
                        <div class="form-group mb-4">
                            <div class="d-flex justify-content-between align-items-center border p-3 rounded bg-light">
                                <div>
                                    ...
                                    <small class="d-block text-muted">Enable/Disable tracking</small>
                                </div>
                                <label class="switch">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-submit">
                                <i class="fe-check-circle me-1"></i> Update Pixel
                            </button>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\pixels\edit.blade.php ENDPATH**/ ?>