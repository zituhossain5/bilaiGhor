...
<?php $__env->startSection('title','Create Childcategory'); ?>
...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('childcategories.store')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>" 
                                   name="childcategoryName" value="<?php echo e(old('childcategoryName')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                   name="meta_title" value="<?php echo e(old('meta_title')); ?>" placeholder="SEO Title">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\childcategory\create.blade.php ENDPATH**/ ?>