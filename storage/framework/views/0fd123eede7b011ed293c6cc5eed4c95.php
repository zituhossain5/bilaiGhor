...
<?php $__env->startSection('title','Customer Complaints'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-bold text-primary"><?php echo e($complaint->ticket_number ?? 'Legacy ticket'); ?></span>
                                    <small class="d-block text-muted"><?php echo e(optional($complaint->created_at)->format('d M Y, h:i A')); ?></small>
                                </td>
                                
                                <td>
                                    <span class="fw-bold text-primary"><?php echo e($complaint->order_reference ?? $complaint->order_id ?? 'N/A'); ?></span>
                                </td>

                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="customer-name"><?php echo e($complaint->name); ?></span>
                                        <span class="customer-phone"><i class="fe-phone me-1"></i><?php echo e($complaint->phone); ?></span>
                                        <?php if($complaint->email): ?>
                                            <span class="customer-phone"><i class="fe-mail me-1"></i><?php echo e($complaint->email); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>

                                <td>
                                    <span class="text-muted" title="<?php echo e($complaint->description); ?>">
                                        <?php echo e(\Illuminate\Support\Str::limit($complaint->description, 50)); ?>
                                ...
                                <td>
                                    <?php if($complaint->image): ?>
                                        <a href="<?php echo e(route('backEnd.complaints.attachment', $complaint)); ?>" target="_blank" rel="noopener">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <form action="<?php echo e(route('backEnd.complaints.status', $complaint->id)); ?>" method="POST" class="d-flex align-items-center gap-1">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form action="<?php echo e(route('backEnd.complaints.destroy', $complaint->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-4">
                        <?php echo e($complaints->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views/backEnd/complaints/index.blade.php ENDPATH**/ ?>