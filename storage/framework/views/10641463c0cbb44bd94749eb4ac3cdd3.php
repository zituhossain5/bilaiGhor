...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('admin.blog.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                    ...
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($blog->image): ?>
                                        <img src="<?php echo e(url('public/'.$blog->image)); ?>" class="blog-img" alt="Blog Image">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('public/backEnd/assets/images/image-placeholder.png')); ?>" class="blog-img" alt="No Image">
                                    <?php endif; ?>
                                </td>

                                <td>
                                    <span class="blog-title" title="<?php echo e($blog->title); ?>"><?php echo e($blog->title); ?></span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('admin.blog.edit',$blog->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>

                                        
                                        <a href="<?php echo e(route('admin.blog.delete',$blog->id)); ?>" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\blog\index.blade.php ENDPATH**/ ?>