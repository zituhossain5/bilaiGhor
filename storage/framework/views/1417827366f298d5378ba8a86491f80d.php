...
<?php $__env->startSection('title','Edit Childcategory'); ?>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit Childcategory: <?php echo e($edit_data->childcategoryName); ?></h4>
                    <p class="text-muted font-size-13 mb-0">Update childcategory details and mapping.</p>
                </div>
                <div class="page-title-right">
                    <a href="<?php echo e(route('childcategories.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
    ...
    <form action="<?php echo e(route('childcategories.update')); ?>" method="POST" name="editForm" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
                                            ...
                                            <optgroup label="<?php echo e($category->name); ?>">
                                                <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($subcat->id); ?>" 
                                                        <?php if($subcat->id == $edit_data->subcategory_id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['childcategoryName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           name="childcategoryName" value="<?php echo e($edit_data->childcategoryName); ?>" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\childcategory\edit.blade.php ENDPATH**/ ?>