...
<?php $__env->startSection('title', 'Courier API Settings'); ?>
                ...
                <div class="courier-panel">
                    <div class="courier-panel-head steadfast">
                        ...
                        <div class="courier-logo">
                            <img src="<?php echo e(asset('public/frontEnd/images/stade.svg')); ?>" alt="Steadfast">
                        </div>
                    </div>
                    <div class="courier-panel-body">
                        <form action="<?php echo e(route('courierapi.update')); ?>" method="POST" data-parsley-validate>
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       name="api_key" value="<?php echo e($steadfast->api_key); ?>" required autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>"
                                       name="secret_key" value="<?php echo e($steadfast->secret_key); ?>" required autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php echo $__env->make('backEnd.apiintegration.partials.steadfast_webhook_fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <div class="courier-status-row">
                                <span><i class="fas fa-power-off text-muted me-1"></i> সার্ভিস চালু</span>
                                <div class="form-check form-switch m-0">
                                    <input class="form-check-input" type="checkbox" name="status" value="1"
                                           <?php if($steadfast->status==1): ?> checked <?php endif; ?>>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="courier-panel">
                    ...
                    <div class="courier-panel-body">
                        <form action="<?php echo e(route('courierapi.update')); ?>" method="POST" data-parsley-validate id="pathao_form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="url"
                                       value="<?php echo e($pathao->url ?? 'https://api-hermes.pathao.com'); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       name="client_id" value="<?php echo e($pathao->client_id ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control <?php $__errorArgs = ['client_secret'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       name="client_secret" value="<?php echo e($pathao->client_secret ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       name="username" value="<?php echo e($pathao->username ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       name="password" value="<?php echo e($pathao->password ?? ''); ?>"
                                       placeholder="••••••••" required autocomplete="new-password" />
                                <small class="text-muted small-hint d-block mt-1">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="courier-status-row">
                                ...
                                <div class="form-check form-switch m-0">
                                    <input class="form-check-input" type="checkbox" name="status" value="1"
                                           <?php if(isset($pathao) && $pathao->status==1): ?> checked <?php endif; ?>>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="courier-panel">
                    ...
                    <div class="courier-panel-body">
                        <form action="<?php echo e(route('courierapi.update')); ?>" method="POST" data-parsley-validate>
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($redx->id ?? ''); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="url" id="redx_url" required>
                                    <option value="sandbox.redx.com.bd/v1.0.0-beta" <?php echo e($currentUrlNormalized == 'sandbox.redx.com.bd/v1.0.0-beta' || strpos($currentUrlNormalized, 'sandbox.redx.com.bd') !== false ? 'selected' : ''); ?>>Sandbox (টেস্টিং)</option>
                                    <option value="openapi.redx.com.bd/v1.0.0-beta" <?php echo e($currentUrlNormalized == 'openapi.redx.com.bd/v1.0.0-beta' || strpos($currentUrlNormalized, 'openapi.redx.com.bd') !== false ? 'selected' : ''); ?>>Production (লাইভ)</option>
                                </select>
                                <small class="text-muted small-hint d-block mt-1">ইনভায়রনমেন্ট ও টোকেন একই হতে হবে।</small>
                                <?php if(!empty($currentUrl)): ?>
                                    <small class="text-info d-block mt-1"><i class="fe-info"></i> বর্তমান: <?php echo e($currentUrl); ?></small>
                                <?php endif; ?>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                       name="token" value="<?php echo e($redx->token ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                           name="webhook_url"
                                           id="redx_webhook_url"
                                           value="<?php echo e($redx->webhook_url ?? ''); ?>"
                                           placeholder="<?php echo e(config('app.url')); ?>/api/redx/webhook"
                                           autocomplete="off" />
                                ...
                                <small class="text-muted small-hint d-block mt-1">
                                    প্রস্তাবিত: <code id="suggested_webhook_url"><?php echo e(config('app.url')); ?>/api/redx/webhook</code><br>
                            ...
                            <div class="courier-status-row">
                                ...
                                <div class="form-check form-switch m-0">
                                    <input class="form-check-input" type="checkbox" name="status" value="1"
                                           <?php if(isset($redx) && $redx->status==1): ?> checked <?php endif; ?>>
                                </div>
                            </div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\apiintegration\courier_manage.blade.php ENDPATH**/ ?>