    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit Blog: <?php echo e(Str::limit($blog->title, 30)); ?></h4>
                    <p class="text-muted font-size-13 mb-0">Update blog content and media.</p>
                </div>
                <div class="page-title-right">
                    <a href="<?php echo e(route('admin.blog.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="short_description" class="form-control" rows="3"><?php echo e($blog->short_description); ?></textarea>
                        </div>

                        <div class="form-group mb-0">
                            <label class="form-label">Full Content <span class="text-danger">*</span></label>
                            <textarea name="description" class="summernote form-control" required><?php echo $blog->description; ?></textarea>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded border border-light">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="status" value="1" <?php echo e($blog->status == 1 ? 'checked' : ''); ?>>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="image-upload-box" onclick="document.getElementById('image').click()">
                            ...
                            <?php if($blog->image): ?>
                                <img id="preview_image" class="preview-img" src="<?php echo e(url('public/'.$blog->image)); ?>" alt="Blog Image" style="display: block;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\blog\edit.blade.php ENDPATH**/ ?>