...
<?php $__env->startSection('title', 'উপজেলা'); ?>
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        ...
        <a href="<?php echo e(route('admin.delivery.upazilas.create', ['district' => $district->id])); ?>" class="btn btn-primary"><i class="fe-plus"></i> নতুন উপজেলা</a>
    </div>
    <div class="card">
        <div class="card-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="<?php echo e(route('admin.delivery.upazilas.edit', $value->id)); ?>" class="btn btn-sm btn-primary">এডিট</a>
                                <form action="<?php echo e(route('admin.delivery.upazilas.destroy')); ?>" method="POST" class="d-inline delete-form-delivery">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\delivery\upazila_index.blade.php ENDPATH**/ ?>