...
<?php $__env->startSection('title','Manage Weights'); ?>
...
<div class="container-fluid">
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('weights.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4"><i class="fe-plus me-1"></i> Add Weight</a>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end"><div class="d-inline-flex gap-2">
                        ...
                        <form method="post" action="<?php echo e(route('weights.inactive')); ?>" class="d-inline"><?php echo csrf_field(); ?><input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id"><button type="submit" class="action-btn btn-inactive" title="Deactivate"><i class="fe-eye-off"></i></button></form>
                        <?php else: ?>
                        <form method="post" action="<?php echo e(route('weights.active')); ?>" class="d-inline"><?php echo csrf_field(); ?><input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id"><button type="submit" class="action-btn btn-active" title="Activate"><i class="fe-eye"></i></button></form>
                        <?php endif; ?>
                        <a href="<?php echo e(route('weights.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit"><i class="fe-edit"></i></a>
                        <form method="post" action="<?php echo e(route('weights.destroy')); ?>" class="d-inline"><?php echo csrf_field(); ?><input type="hidden" name="hidden_id" value="<?php echo e($value->id); ?>"><button type="submit" class="action-btn btn-delete delete-confirm" title="Delete"><i class="fe-trash-2"></i></button></form>
                    </div></td>
                </tr>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\weight\index.blade.php ENDPATH**/ ?>