...
<?php $__env->startSection('title', 'উপজেলা যোগ'); ?>
<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-body">
            <h5 class="mb-3">নতুন উপজেলা — <?php echo e($district->name); ?></h5>
            <form action="<?php echo e(route('admin.delivery.upazilas.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(route('admin.delivery.upazilas.index', $district->id)); ?>" class="btn btn-light">ফিরে যান</a>
            </form>
        </div>
    </div>
</div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\delivery\upazila_create.blade.php ENDPATH**/ ?>