...
<?php $__env->startSection('title','Pending Reviews'); ?>
...
<style>
    ...
    .btn-approve:hover { background-color: rgba(10, 207, 151, 0.1); color: #0acf97; }
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('reviews.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="customer-info">
                                            ...
                                            <small><?php echo e($value->email); ?></small>
                                        </div>
                                    </div>
                                </td>
                                
                                <td>
                                    <span class="text-muted" title="<?php echo e($value->review); ?>">
                                        <?php echo e(Str::limit($value->review, 60)); ?>
                                ...
                                <td>
                                    <div class="star-rating">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <i class="mdi mdi-star <?php echo e($i <= $value->ratting ? 'filled' : ''); ?>"></i>
                                        <?php endfor; ?>
                                        <span class="ms-1 text-dark fw-bold font-size-12">(<?php echo e($value->ratting); ?>.0)</span>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('reviews.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\review\pending.blade.php ENDPATH**/ ?>