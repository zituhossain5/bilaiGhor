...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('categories.store')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>" 
                                   name="meta_title" value="<?php echo e(old('meta_title')); ?>" id="meta_title" 
...
unset($__errorArgs, $__bag); ?>"
                                      name="meta_description" id="meta_description"><?php echo e(old('meta_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                      name="full_description" id="full_description"><?php echo e(old('full_description')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\category\create.blade.php ENDPATH**/ ?>