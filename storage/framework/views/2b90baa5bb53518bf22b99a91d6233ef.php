            ...
            <form action="<?php echo e(route('admin.coupons.update', $coupon->id)); ?>" method="POST">
                ...
                <div class="card card-modern">
                    ...
                    <div class="card-header-modern">
                        ...
                        <a href="<?php echo e(route('admin.coupons.index')); ?>" class="btn btn-light btn-sm rounded-pill px-3">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <select name="type" id="discount_type" class="form-select form-select-custom">
                                    <option value="flat" <?php echo e($coupon->type == 'flat' ? 'selected' : ''); ?>>Fixed Amount (Flat)</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="value" class="form-control form-control-custom border-start-0" 
                                           value="<?php echo e(old('value', $coupon->value)); ?>" required style="border-radius: 0 10px 10px 0;">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="min_purchase" class="form-control form-control-custom border-start-0" 
                                           value="<?php echo e(old('min_purchase', $coupon->min_purchase)); ?>" style="border-radius: 0 10px 10px 0;">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('admin.coupons.index')); ?>" class="btn btn-light py-2">Discard Changes</a>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\coupon\edit.blade.php ENDPATH**/ ?>