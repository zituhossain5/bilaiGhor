...
<section class="bpd-tabs-section">
    <div class="container">
        ...
        <div class="bpd-tab-nav">
            ...
            <button class="bilai-product-tab" onclick="bpdTab(this,'tab-reviews')" type="button">Reviews (<?php echo e($reviewTotal); ?>)</button>
        </div>
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views/frontEnd/layouts/pages/details.blade.php ENDPATH**/ ?>