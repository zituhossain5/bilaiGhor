...
<style>
    ...
    .preview-img { width: 90px; height: 90px; border-radius: 50%; object-fit: cover; box-shadow: 0 4px 10px rgba(0,0,0,0.08); }
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit Testimonial</h4>
                    <p class="text-muted font-size-13 mb-0">Update customer testimonial details.</p>
                </div>
                <div class="page-title-right">
                    <a href="<?php echo e(route('admin.testimonial.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="location" class="form-control"
                                       value="<?php echo e(old('location', $testimonial->location)); ?>" placeholder="e.g. Dhaka, Bangladesh">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="sort_order" class="form-control"
                                       value="<?php echo e(old('sort_order', $testimonial->sort_order)); ?>" min="0">
                            </div>
                        </div>
                        <div class="mb-0">
...
unset($__errorArgs, $__bag); ?>"
                                      required><?php echo e(old('message', $testimonial->message)); ?></textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded border border-light">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="status" value="1" <?php echo e($testimonial->status ? 'checked' : ''); ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                        <button type="submit" class="btn btn-submit w-100 rounded-pill">
                            <i class="fe-check-circle me-1"></i> Update Testimonial
                        </button>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="image-upload-box" onclick="document.getElementById('image').click()">
                            ...
                            <?php if($testimonial->image): ?>
                                <img id="preview_image" class="preview-img" src="<?php echo e(asset('public/'.$testimonial->image)); ?>" alt="">
                                <div id="upload_placeholder" class="upload-placeholder mt-2" style="display:none;">
                            <?php else: ?>
                                <img id="preview_image" class="preview-img" src="#" alt="" style="display:none;">
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small mt-2 text-center"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\testimonial\edit.blade.php ENDPATH**/ ?>