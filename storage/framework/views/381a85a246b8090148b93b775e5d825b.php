...
<body>
    <div class="card">
        ...
        <p style="color:#fca5a5;font-size:0.9rem;margin-top:12px;padding:12px;background:rgba(0,0,0,0.25);border-radius:8px;">
            <?php echo e($serverMessage); ?>

        </p>
        <?php endif; ?>
        <p>এডমিন প্যানেল লক। ফ্রন্ট সাইট (শপ) স্বাভাবিকভাবে চলতে পারে।</p>
        <p class="note">লাইসেন্স নিন বা সক্রিয় করুন:
            <a href="https://www.bmitltd.com/license?domain=<?php echo e(urlencode(request()->getHost())); ?>" target="_blank" rel="noopener">Creative Design License</a>
        </p>
        <div class="domain"><?php echo e(request()->getHost()); ?></div>
        <div class="actions">
            <a href="https://www.bmitltd.com/license?domain=<?php echo e(urlencode(request()->getHost())); ?>" class="btn btn-primary" target="_blank" rel="noopener">
                লাইসেন্স সক্রিয় করুন
            </a>
            <a href="<?php echo e(url('/')); ?>" class="btn btn-outline">হোমপেজে যান</a>
        </div>
        <p class="note">সমস্যা থাকলে BMITLTD সাপোর্টের সাথে যোগাযোগ করুন।</p>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\license\locked.blade.php ENDPATH**/ ?>