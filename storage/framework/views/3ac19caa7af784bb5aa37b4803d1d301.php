...
<style>
    ...
    /* Childcategory Specific Styles */
    .child-name { font-weight: 600; color: #343a40; font-size: 14px; }
    .sub-cat { font-size: 12px; font-weight: 500; }
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('childcategories.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($value->subcategory): ?>
                                        <span class="badge badge-pill badge-soft-info sub-cat">
                                            <i class="fe-corner-down-right me-1"></i> <?php echo e($value->subcategory->subcategoryName); ?>
                                ...
                                <td>
                                    <span class="child-name"><?php echo e($value->childcategoryName); ?></span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('childcategories.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\childcategory\index.blade.php ENDPATH**/ ?>