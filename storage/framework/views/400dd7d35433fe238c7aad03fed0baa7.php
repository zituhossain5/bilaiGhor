                ...
                <div class="card card-modern">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="p-3 bg-light rounded-3 mb-4 border">
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    ...
                                    <input type="date" name="valid_from" class="form-control form-control-custom" value="<?php echo e(date('Y-m-d')); ?>">
                                </div>
                                <div class="col-6">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('admin.coupons.index')); ?>" class="btn btn-light py-2">Cancel</a>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\coupon\create.blade.php ENDPATH**/ ?>