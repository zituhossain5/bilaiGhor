...
<tr>
    <td>মোট ছাড়</td>
    <td class="text-end text-danger">−৳<?php echo e(number_format($totalDiscount, 2)); ?></td>
</tr>
<tr class="oe-summary-total">
    <td>মোট পরিশোধ</td>
    <td class="text-end">৳<?php echo e(number_format($grandTotal, 2)); ?></td>
</tr>
<?php if($orderId): ?>
<tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\order\cart_details_edit.blade.php ENDPATH**/ ?>