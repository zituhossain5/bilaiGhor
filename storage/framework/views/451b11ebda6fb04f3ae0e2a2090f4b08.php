...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('customers.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('customers.update')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="phone" value="<?php echo e($edit_data->phone); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="address" value="<?php echo e($edit_data->address); ?>" required>
                                ...
                                <div class="card bg-light border-0">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mx-auto image-preview-container">
                                            <img src="<?php echo e(asset($edit_data->image)); ?>" alt="user-image" id="preview-image">
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\customer\edit.blade.php ENDPATH**/ ?>