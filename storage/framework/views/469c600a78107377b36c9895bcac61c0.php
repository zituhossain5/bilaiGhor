...
<style>
    ...
    .brand-img {
        ...
        height: 50px;
        border-radius: 8px;
        object-fit: contain; /* ব্র্যান্ড লোগোর জন্য contain ভালো */
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;">Brands</h4>
            <a href="<?php echo e(route('brands.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                <i class="fe-plus me-1"></i> Add Brand
            </a>
        </div>
    </div>
                    ...
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo e(asset($value->image)); ?>" class="brand-img" alt="<?php echo e($value->name); ?>">
                                </td>

                                <td>
                                    <span class="brand-name"><?php echo e($value->name); ?></span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('brands.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\brand\index.blade.php ENDPATH**/ ?>