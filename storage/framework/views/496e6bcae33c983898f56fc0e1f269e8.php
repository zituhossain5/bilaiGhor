                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted d-block text-truncate" style="max-width: 250px;">
                                            <?php echo e($value->description ?? 'No description'); ?>
            ...
            <form action="<?php echo e(route('admin.popup.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control bg-light border-0" name="link" placeholder="https://... (ইমেজে ক্লিক করলে এই লিংকে যাবে)" value="<?php echo e(old('link')); ?>">
                    </div>
                            ...
                            <div id="advancedFields" class="accordion-collapse collapse" data-bs-parent="#advancedPopup">
                                <div class="accordion-body pt-0">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control bg-white border" name="title" placeholder="Ex: Eid Offer" value="<?php echo e(old('title')); ?>">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label fw-bold small text-muted">বর্ণনা / সাবটাইটেল</label>
                                        <textarea class="form-control bg-white border" name="description" rows="2" placeholder="বর্ণনা..."><?php echo e(old('description')); ?></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="form-label fw-bold small text-muted">বাটন টেক্সট</label>
                                            <input type="text" class="form-control bg-white border" name="btn_text" value="<?php echo e(old('btn_text')); ?>" placeholder="Shop Now">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-bold small text-muted">ফুটার টেক্সট</label>
                                            <input type="text" class="form-control bg-white border" name="offer_end_text" value="<?php echo e(old('offer_end_text')); ?>" placeholder="Offer ends...">
                                        </div>
                                    </div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views/backEnd/popup/index.blade.php ENDPATH**/ ?>