...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit Size: <?php echo e($edit_data->sizeName); ?></h4>
                    <p class="text-muted font-size-13 mb-0">Update size details.</p>
                </div>
                <div class="page-title-right">
                    <a href="<?php echo e(route('sizes.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
    ...
    <form action="<?php echo e(route('sizes.update')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   name="sizeName" value="<?php echo e($edit_data->sizeName); ?>" id="sizeName" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\size\edit.blade.php ENDPATH**/ ?>