...
<?php $__env->startSection('title', 'প্রোফাইল সেটিংস'); ?>
<?php $__env->startSection('page-title', 'সেটিংস'); ?>
        ...
        <div class="settings-card h-100">
            <div class="p-4 border-bottom text-center bg-light">
                <div class="avatar-wrapper mb-3">
                    <img src="<?php echo e($user->image ? asset($user->image) : 'https://ui-avatars.com/api/?name='.urlencode($user->name).'&background=4f46e5&color=fff'); ?>" 
                         alt="Profile" class="profile-pic">
                </div>
                <h6 class="fw-bold text-dark mb-0"><?php echo e($user->name); ?></h6>
                <small class="text-muted"><?php echo e($user->shop_name ?? 'Reseller'); ?></small>
            </div>
    ...
    <div class="col-lg-9">
        ...
        <div id="profile" class="tab-pane active">
            <div class="settings-card p-4">
                ...
                <form action="<?php echo e(route('reseller.settings.profile')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    
                    <div class="d-flex align-items-center mb-4 p-3 bg-light rounded-3 border">
                        <div class="avatar-wrapper me-4 ms-0">
                            <img id="previewImg" src="<?php echo e($user->image ? asset($user->image) : 'https://ui-avatars.com/api/?name='.urlencode($user->name).'&background=random'); ?>" class="profile-pic">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['shop_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="shop_name" value="<?php echo e(old('shop_name', $user->shop_name)); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone', $customer->phone ?? '')); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div id="password" class="tab-pane">
            <div class="settings-card p-4">
                ...
                <form action="<?php echo e(route('reseller.settings.password')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row g-4">
                        <div class="col-12">
...
unset($__errorArgs, $__bag); ?>" name="current_password" required placeholder="••••••••">
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="password" required placeholder="কমপক্ষে ৬ অক্ষর">
                            </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div id="payment" class="tab-pane">
            <div class="settings-card p-5 text-center">
                ...
                <a href="<?php echo e(route('reseller.withdrawals.index')); ?>" class="btn btn-outline-primary rounded-pill">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\settings.blade.php ENDPATH**/ ?>