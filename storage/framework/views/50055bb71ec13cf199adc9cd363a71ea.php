...
<?php $__env->startSection('title','Manage Colors'); ?>
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('colors.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="color-swatch" style="background-color: <?php echo e($value->color); ?>;" title="<?php echo e($value->color); ?>"></div>
                                        <div class="color-info">
                                            <h6><?php echo e($value->colorName); ?></h6>
                                            <small><?php echo e($value->color); ?></small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('colors.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\color\index.blade.php ENDPATH**/ ?>