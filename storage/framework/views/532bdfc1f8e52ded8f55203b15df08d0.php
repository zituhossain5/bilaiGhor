...
<?php if (! $__env->hasRenderedOnce('77ede67d-dcc3-455a-9d8c-f9b295a8a5e4')): $__env->markAsRenderedOnce('77ede67d-dcc3-455a-9d8c-f9b295a8a5e4'); ?>
...
<div id="bilai-afm-modal" class="bilai-afm-overlay" aria-hidden="true">
    <div class="bilai-afm-dialog" role="dialog" aria-label="Address form">
        ...
        <div class="bilai-afm-body">
            <?php if($__afmReopen && $errors->any()): ?>
                <div class="bilai-afm-error"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            <form id="bilai-afm-form" action="<?php echo e(route('customer.addresses.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="bilai-afm-row">
                    ...
                    <div class="bilai-afm-field">
                        ...
                        <select name="adr_district_id" id="bilai-afm-district" required>
                            ...
                            <?php $__currentLoopData = $__afmDistricts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if (! $__env->hasRenderedOnce('d1e98c5f-b7f7-4be3-ab87-817030b21797')): $__env->markAsRenderedOnce('d1e98c5f-b7f7-4be3-ab87-817030b21797'); ?>
...
(function () {
    ...
    var storeUrl  = '<?php echo e(route('customer.addresses.store')); ?>';
    var updateUrlBase = '<?php echo e(url('/customer/addresses')); ?>'; // + /{id}/update
    ...
    var REOPEN = <?php echo json_encode($__afmReopen, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\partials\address-form-modal.blade.php ENDPATH**/ ?>