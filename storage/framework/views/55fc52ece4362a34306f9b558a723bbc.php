...
<?php $__env->startSection('title', 'Add Leave Request'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <form action="<?php echo e(route('admin.leaves.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="casual" <?php echo e(old('leave_type') == 'casual' ? 'selected' : ''); ?> class="leave-type-option">Casual Leave</option>
                                <option value="sick" <?php echo e(old('leave_type') == 'sick' ? 'selected' : ''); ?> class="leave-type-option">Sick Leave</option>
                                <option value="annual" <?php echo e(old('leave_type') == 'annual' ? 'selected' : ''); ?> class="leave-type-option">Annual Leave</option>
                                <option value="emergency" <?php echo e(old('leave_type') == 'emergency' ? 'selected' : ''); ?> class="leave-type-option">Emergency Leave</option>
                                <option value="maternity" <?php echo e(old('leave_type') == 'maternity' ? 'selected' : ''); ?> class="leave-type-option">Maternity Leave</option>
                                <option value="paternity" <?php echo e(old('leave_type') == 'paternity' ? 'selected' : ''); ?> class="leave-type-option">Paternity Leave</option>
                                <option value="unpaid" <?php echo e(old('leave_type') == 'unpaid' ? 'selected' : ''); ?> class="leave-type-option">Unpaid Leave</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="reason" class="form-control form-control-custom" rows="4" placeholder="Briefly describe the reason..."><?php echo e(old('reason')); ?></textarea>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('admin.leaves.index')); ?>" class="btn btn-light py-2">Cancel</a>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\leaves\create.blade.php ENDPATH**/ ?>