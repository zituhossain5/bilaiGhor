...
<?php $__env->startSection('title','Create Shipping Charge'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <button type="submit" form="shippingCreateForm" class="btn btn-primary fw-bold px-4 shadow-sm">
                <i class="fe-plus me-1"></i> Save Configuration
            </button>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            ...
            <div class="studio-card p-4">
                <form action="<?php echo e(route('shippingcharges.store')); ?>" method="POST" id="shippingCreateForm" data-parsley-validate="">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\shippingcharge\create.blade.php ENDPATH**/ ?>