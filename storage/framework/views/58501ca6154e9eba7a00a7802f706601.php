...
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-3 mt-3">
        ...
        <div class="col-6 text-end">
            <a href="<?php echo e(route('brands.index')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
                <i class="fe-arrow-left me-1"></i> Back
            </a>
        </div>
    </div>

    <form action="<?php echo e(route('brands.store')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\brand\create.blade.php ENDPATH**/ ?>