<script>
(function () {
    var popupUrl = <?php echo json_encode(route('admin.dashboard.new_orders_popup'), 15, 512) ?>;
    var dismissUrl = <?php echo json_encode(route('admin.dashboard.dismiss_new_orders_popup'), 15, 512) ?>;
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views/backEnd/admin/partials/new_orders_popup_script.blade.php ENDPATH**/ ?>