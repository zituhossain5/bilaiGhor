...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('name')); ?>" placeholder="e.g. Rina Akter" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="location" class="form-control"
                                       value="<?php echo e(old('location')); ?>" placeholder="e.g. Dhaka, Bangladesh">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
...
unset($__errorArgs, $__bag); ?>" required>
                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e(old('rating', 5) == $i ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="sort_order" class="form-control"
                                       value="<?php echo e(old('sort_order', 0)); ?>" placeholder="0" min="0">
                            </div>
                        </div>
                        <div class="mb-0">
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Customer's testimonial..." required><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\testimonial\create.blade.php ENDPATH**/ ?>