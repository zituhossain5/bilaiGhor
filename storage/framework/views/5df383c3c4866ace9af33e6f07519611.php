...
<?php $__env->startSection('title','TikTok Pixel Management'); ?>
...
<div class="container-fluid">
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('tiktok.pixels.create')); ?>" class="btn btn-dark rounded-pill shadow-sm px-4">
                    ...
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="pixel-code"><?php echo e($value->code); ?></span></td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        <?php if($value->status == 1): ?>
                                            <form method="post" action="<?php echo e(route('tiktok.pixels.inactive')); ?>" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <form method="post" action="<?php echo e(route('tiktok.pixels.active')); ?>" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('tiktok.pixels.edit', $value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
                                        <form method="post" action="<?php echo e(route('tiktok.pixels.destroy')); ?>" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\tiktok_pixels\index.blade.php ENDPATH**/ ?>