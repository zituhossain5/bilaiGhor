...
<?php $__env->startSection('title', 'My Orders | ' . ($customer->name ?? 'Account')); ?>
            ...
            <aside class="bilai-dash-sidebar">
                ...
                <div class="bilai-card">
                    <nav class="bilai-dash-nav">
                        ...
                        <form id="bilai-ord-logout-form" action="<?php echo e(route('customer.logout')); ?>" method="POST" style="display:none;">
                            <?php echo csrf_field(); ?>
                        </form>
                    </nav>
                </div>
            ...
            <main>
                <div class="bilai-card bilai-ord-card">
                    ...
                    <div class="bilai-ord-tabs">
                        <a href="<?php echo e(route('customer.orders')); ?>"
                           class="bilai-ord-tab <?php echo e($activeTab === 'all' ? 'active' : ''); ?>">All</a>
                        <a href="<?php echo e(route('customer.orders', ['status' => 'confirmed'])); ?>"
                           class="bilai-ord-tab <?php echo e($activeTab === 'confirmed' ? 'active' : ''); ?>">Confirmed</a>
                        <a href="<?php echo e(route('customer.orders', ['status' => 'processing'])); ?>"
                           class="bilai-ord-tab <?php echo e($activeTab === 'processing' ? 'active' : ''); ?>">Processing</a>
                        <a href="<?php echo e(route('customer.orders', ['status' => 'cancelled'])); ?>"
                           class="bilai-ord-tab <?php echo e($activeTab === 'cancelled' ? 'active' : ''); ?>">Cancelled</a>
                    </div>
                    ...
                    <?php if($orders->count() > 0): ?>
                        <div class="bilai-ord-table-wrap">
                            <table class="bilai-ord-table">
                                ...
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td style="font-weight:600;">#<?php echo e($value->invoice_id ?? $value->id); ?></td>
                                        <td style="color:var(--bilai-dash-muted); white-space:nowrap;">
                                            <?php echo e($value->created_at->format('M j, Y')); ?>

                                        </td>
                                        <td>
                                            <span class="bilai-ord-product-name" title="<?php echo e($firstProductName); ?>">
                                                <?php echo e($firstProductName); ?>

                                            </span>
                                            <?php if($moreItems > 0): ?>
                                                <span style="font-size:11px; color:var(--bilai-dash-muted);">+<?php echo e($moreItems); ?> more</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <span class="bilai-ord-badge <?php echo e($badgeClass); ?>"><?php echo e($badgeText); ?></span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="bilai-ord-actions">
                                                <a href="<?php echo e(route('customer.order_details', $value->id)); ?>"
                                                   class="bilai-ord-btn-view">View Details</a>

                                                <?php if($value->admin_note): ?>
                                                    <a href="<?php echo e(route('customer.order_note', ['id' => $value->id])); ?>"
                                                ...
                                                <?php if($canRefund): ?>
                                                    <a href="<?php echo e(route('customer.refunds.create', $value->id)); ?>"
                                                       class="bilai-ord-btn-sm" style="background:#fefce8; color:#a16207;" title="Request Refund">
                                                        
                                                        <i class="fa fa-undo"></i>
                                                    </a>
                                                <?php elseif($existingRefund): ?>
                                                    <a href="<?php echo e(route('customer.refunds.show', $existingRefund->id)); ?>"
                        ...
                        <?php if(method_exists($orders, 'hasPages') && $orders->hasPages()): ?>
                            <div class="bilai-ord-pagination">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($orders->previousPageUrl()); ?>" class="bilai-ord-page-btn"><i class="fa fa-chevron-left"></i></a>
                                <?php endif; ?>
                                ...
                                <?php if($sp > 1): ?>
                                    <a href="<?php echo e($orders->url(1)); ?>" class="bilai-ord-page-btn">1</a>
                                    <?php if($sp > 2): ?><span style="color:var(--bilai-dash-muted);padding:0 2px;">…</span><?php endif; ?>
                                <?php endif; ?>

                                <?php for($pg = $sp; $pg <= $ep; $pg++): ?>
                                    <?php if($pg == $cp): ?>
                                        <span class="bilai-ord-page-btn active"><?php echo e($pg); ?></span>
                                    <?php else: ?>
                                        <a href="<?php echo e($orders->url($pg)); ?>" class="bilai-ord-page-btn"><?php echo e($pg); ?></a>
                                    <?php endif; ?>
                                <?php endfor; ?>

                                <?php if($ep < $lp): ?>
                                    <?php if($ep < $lp - 1): ?><span style="color:var(--bilai-dash-muted);padding:0 2px;">…</span><?php endif; ?>
                                    <a href="<?php echo e($orders->url($lp)); ?>" class="bilai-ord-page-btn"><?php echo e($lp); ?></a>
                                <?php endif; ?>

                                <?php if($orders->hasMorePages()): ?>
                                    <a href="<?php echo e($orders->nextPageUrl()); ?>" class="bilai-ord-page-btn"><i class="fa fa-chevron-right"></i></a>
                                <?php else: ?>
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\orders.blade.php ENDPATH**/ ?>