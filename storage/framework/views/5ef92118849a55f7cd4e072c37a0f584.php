...
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-4 mt-4">
        <div class="col">
            <h4 class="m-0 font-weight-bold text-dark">Edit Brand: <?php echo e($edit_data->name); ?></h4>
        </div>
        <div class="col-auto">
            <a href="<?php echo e(route('brands.index')); ?>" class="btn btn-light border btn-sm rounded-pill px-3 shadow-sm">
                <i class="fe-arrow-left me-1"></i> Back
            </a>
        </div>
    </div>

    <form action="<?php echo e(route('brands.update')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   name="name" value="<?php echo e($edit_data->name); ?>" id="name" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="action-toolbar">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <input type="checkbox" id="status" name="status" value="1" class="toggle-checkbox" <?php echo e($edit_data->status == 1 ? 'checked' : ''); ?>>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="logo-upload-container p-0">
                            <div class="logo-preview-box" onclick="document.getElementById('image').click()">
                                <img id="preview_image" src="<?php echo e(asset($edit_data->image)); ?>" alt="Logo">
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <div class="text-danger small mt-2 text-center"><?php echo e($message); ?></div>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\brand\edit.blade.php ENDPATH**/ ?>