...
<head>
    ...
    <title>My Order History | <?php echo e($siteName->name ?? 'Gadget Style'); ?></title>
...
<body class="flex min-h-screen relative">
    ...
    <main class="flex-1 overflow-y-auto h-screen w-full">
        ...
        <div class="p-4 lg:p-8 max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($orders->count()); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($pendingOrdersCount); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800">৳<?php echo e(number_format($totalOrderAmount, 0)); ?></p>
                        </div>
            ...
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    // Payment Logic
                                        ...
                                        <div class="flex items-start justify-between gap-4 mb-4">
                                            <div class="flex-1">
                                                <div class="flex items-center gap-2 mb-1">
                                                    <h4 class="text-base font-bold text-gray-800">#<?php echo e($value->invoice_id ?? $value->id); ?></h4>
                                                    <span class="<?php echo e($statusClass); ?> px-2 py-0.5 rounded text-xs font-semibold"><?php echo e($statusText); ?></span>
                                                </div>
                                                <p class="text-xs text-gray-500"><?php echo e($value->created_at->format('d M, Y - h:i A')); ?></p>
                                            </div>
                                            <div class="text-right">
                                                <p class="text-lg font-bold text-gray-800">৳<?php echo e(number_format($grand_total, 2)); ?></p>
                                            </div>
                                        </div>

                                        
                                        <?php if($value->orderdetails && $value->orderdetails->count() > 0): ?>
                                            <div class="flex gap-2 mb-4 pb-4 border-b border-gray-100">
                                                <?php $__currentLoopData = $value->orderdetails->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        $productImage = null;
                                                    ...
                                                    ?>
                                                    <img src="<?php echo e($productImage ? asset($productImage) : asset('public/uploads/default/no-image.png')); ?>" 
                                                         ...
                                                         alt="<?php echo e($detail->product_name ?? 'Product'); ?>">
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($value->orderdetails->count() > 5): ?>
                                                    <div class="w-12 h-12 rounded bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-500 text-xs font-bold">
                                                        +<?php echo e($value->orderdetails->count() - 5); ?>
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                            ...
                                            <div class="flex items-center gap-3 text-sm">
                                                <div>
                                                    ...
                                                    <span class="font-semibold <?php echo e($paid_amount > 0 ? 'text-green-600' : 'text-gray-400'); ?>">৳<?php echo e(number_format($paid_amount, 2)); ?></span>
                                                </div>
                                                <div>
                                                    <span class="text-gray-500">Due: </span>
                                                    <span class="font-semibold <?php echo e($due_amount > 0 ? 'text-red-600' : 'text-gray-400'); ?>">৳<?php echo e(number_format($due_amount, 2)); ?></span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="flex items-center gap-2">
                                                <a href="<?php echo e(route('customer.invoice',['id'=>$value->id])); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white text-xs px-4 py-2 rounded-lg transition font-semibold flex items-center gap-1">
                                                    <i class="fas fa-eye"></i>
                                                    <span class="hidden sm:inline">দেখুন</span>
                                                </a>
                                                <?php if($value->admin_note): ?>
                                                    <a href="<?php echo e(route('customer.order_note',['id'=>$value->id])); ?>" class="bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 py-2 rounded-lg transition" title="Admin Note">
                                                ...
                                                <?php endif; ?>
                                                <?php if($canRefund): ?>
                                                    <a href="<?php echo e(route('customer.refunds.create', $value->id)); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white text-xs px-3 py-2 rounded-lg transition" title="Request Refund">
                                                        <i class="fas fa-undo"></i>
                                                    </a>
                                                <?php elseif($existingRefund): ?>
                                                    <a href="<?php echo e(route('customer.refunds.show', $existingRefund->id)); ?>" class="bg-purple-500 hover:bg-purple-600 text-white text-xs px-3 py-2 rounded-lg transition" title="View Refund">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                <?php endif; ?>
                                            </div>
            ...
            <?php if(method_exists($orders, 'hasPages') && $orders->hasPages()): ?>
                <div class="mt-6 flex justify-center">
                    <div class="flex items-center gap-2 flex-wrap justify-center">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($orders->previousPageUrl()); ?>" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                                <i class="fas fa-chevron-left"></i>
                            </a>
                        <?php endif; ?>
                        ...
                        <?php if($startPage > 1): ?>
                            <a href="<?php echo e($orders->url(1)); ?>" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">1</a>
                            <?php if($startPage > 2): ?>
                        ...
                        <?php for($page = $startPage; $page <= $endPage; $page++): ?>
                            <?php if($page == $currentPage): ?>
                                <span class="px-4 py-2 bg-indigo-600 text-white rounded-lg font-semibold"><?php echo e($page); ?></span>
                            <?php else: ?>
                                <a href="<?php echo e($orders->url($page)); ?>" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition"><?php echo e($page); ?></a>
                            <?php endif; ?>
                        <?php endfor; ?>
                        ...
                        <?php if($endPage < $lastPage): ?>
                            <?php if($endPage < $lastPage - 1): ?>
                                <span class="px-2 text-gray-400">...</span>
                            <?php endif; ?>
                            <a href="<?php echo e($orders->url($lastPage)); ?>" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition"><?php echo e($lastPage); ?></a>
                        <?php endif; ?>

                        
                        <?php if($orders->hasMorePages()): ?>
                            <a href="<?php echo e($orders->nextPageUrl()); ?>" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
...
<?php /**PATH D:\projects\bilaiGhor\resources\views/frontEnd/layouts/customer/orders.blade.php ENDPATH**/ ?>