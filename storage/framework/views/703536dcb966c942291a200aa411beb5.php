...
<li>
  ...
  <div class="collapse" id="siebar-product">
    <ul class="nav-second-level">
      ...
      <?php endif; ?>
      <li><a href="<?php echo e(route('weights.index')); ?>"><i data-feather="file-plus"></i> Weights</a></li>
      <li><a href="<?php echo e(route('lifestages.index')); ?>"><i data-feather="file-plus"></i> Life Stages</a></li>
      <li><a href="<?php echo e(route('flavors.index')); ?>"><i data-feather="file-plus"></i> Flavors</a></li>
    </ul>
  </div>
</li>
<?php endif; ?>
...
<li>
  <a href="#sidebar-inventory" data-bs-toggle="collapse">
    ...
    <span> Inventory </span>
    <?php if($invLowCount > 0): ?>
      <span class="badge bg-danger rounded-pill float-end me-2"><?php echo e($invLowCount); ?></span>
    <?php endif; ?>
    <span class="menu-arrow"></span>
  </a>
  <div class="collapse" id="sidebar-inventory">
    <ul class="nav-second-level">
      <li><a href="<?php echo e(route('admin.inventory.dashboard')); ?>"><i data-feather="grid"></i> Dashboard</a></li>
      <li><a href="<?php echo e(route('admin.inventory.stock')); ?>"><i data-feather="layers"></i> Stock Overview</a></li>
      <li><a href="<?php echo e(route('admin.inventory.movements')); ?>"><i data-feather="list"></i> Stock Movements</a></li>
      <li><a href="<?php echo e(route('admin.inventory.low_stock')); ?>"><i data-feather="alert-triangle"></i> Low Stock</a></li>
      <li><a href="<?php echo e(route('admin.inventory.adjust')); ?>"><i data-feather="sliders"></i> Stock Adjustments</a></li>
      <li><a href="<?php echo e(route('admin.inventory.reports')); ?>"><i data-feather="bar-chart-2"></i> Reports</a></li>
    </ul>
  </div>
</li>
...
<li>
  ...
  <div class="collapse <?php echo e(request()->routeIs('admin.delivery.*', 'admin.delivery-boys.*') ? 'show' : ''); ?>" id="sidebar-delivery-module">
    <ul class="nav-second-level">
      ...
      <li><a href="<?php echo e(route('admin.delivery.divisions.index')); ?>"><i data-feather="map-pin"></i> Delivery locations <span class="text-muted" style="font-size:.75rem;">(Division → District → Zone)</span></a></li>
      <?php endif; ?>
    </ul>
  </div>
</li>
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>