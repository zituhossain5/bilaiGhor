...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('sizes.store')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>" 
                                   name="sizeName" value="<?php echo e(old('sizeName')); ?>" id="sizeName" 
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <p class="mb-0 font-size-13 text-info">
                                You can add multiple sizes like S, M, L, XL or numeric sizes like 30, 32, 40 etc.
                            </p>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\size\create.blade.php ENDPATH**/ ?>