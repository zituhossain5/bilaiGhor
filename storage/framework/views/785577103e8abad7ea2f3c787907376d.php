...
unset($__errorArgs, $__bag); ?>
                    <?php $__inv = \App\Models\InventoryStock::where('product_id', $edit_data->id)->first(); ?>
                    <?php if($__inv): ?>
                        <small class="text-muted d-block mt-1">
                            Inventory: On hand <strong><?php echo e($__inv->on_hand); ?></strong> ·
                            Reserved <strong><?php echo e($__inv->reserved); ?></strong> ·
                            Available <strong><?php echo e($__inv->on_hand - $__inv->reserved); ?></strong>
                            — changes here are logged as a correction.
                            <a href="<?php echo e(route('admin.inventory.adjust', ['product_id' => $edit_data->id])); ?>">Adjust instead</a>
                        </small>
                    <?php endif; ?>
                </div>
                <div class="col-6">
                ...
                <div class="col-12">
                    ...
                    <select class="form-control form-control-sm select2" name="weight_id">
                        ...
                        <?php $__currentLoopData = $weights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($w->id); ?>" <?php if($edit_data->weight_id==$w->id): ?> selected <?php endif; ?>><?php echo e($w->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-12">
                    ...
                    <select class="form-control form-control-sm select2" name="life_stage_id">
                        ...
                        <?php $__currentLoopData = $lifeStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($ls->id); ?>" <?php if($edit_data->life_stage_id==$ls->id): ?> selected <?php endif; ?>><?php echo e($ls->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-12">
                    ...
                    <select class="form-control form-control-sm select2" name="flavor_id">
                        ...
                        <?php $__currentLoopData = $flavors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($fl->id); ?>" <?php if($edit_data->flavor_id==$fl->id): ?> selected <?php endif; ?>><?php echo e($fl->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>"
            ...
            <div class="row text-center g-compact mt-2">
                <div class="col-3">
                    ...
                    <label class="switch"><input type="checkbox" value="1" name="new_arrival" <?php if($edit_data->new_arrival==1): ?> checked <?php endif; ?>><span class="slider round"></span></label>
                </div>
            </div>
            ...
            <div class="mt-2">
                ...
                <select name="product_badge" class="form-control form-control-sm">
                    ...
                    <?php $__currentLoopData = ['Best Seller','Limited Offer','New Arrival','Top Rated','Exclusive Deal','Limited Stock','Customer Favorite','Best Value',"Editor's Pick",'Hot Deal','Trending']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($badge); ?>" <?php if(old('product_badge', $edit_data->product_badge) === $badge): ?> selected <?php endif; ?>><?php echo e($badge); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\product\partials\edit_sidebar.blade.php ENDPATH**/ ?>