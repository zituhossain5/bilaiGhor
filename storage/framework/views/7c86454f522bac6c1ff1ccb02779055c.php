...
<?php $__env->startSection('title', 'Profile | ' . ($profile_edit->name ?? 'Account')); ?>
        ...
        <div class="bilai-prof-layout">
            ...
            <aside class="bilai-prof-sidebar">
                <div class="bilai-card">
                    <div class="bilai-dash-profile-box">
                        <div class="bilai-dash-profile-row">
                            <?php if($profileImage): ?>
                                <img src="<?php echo e($profileImage); ?>" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';" class="bilai-dash-avatar" alt="<?php echo e($profile_edit->name); ?>">
                ...
                <div class="bilai-card">
                    <nav class="bilai-dash-nav">
                        ...
                        <a href="<?php echo e(route('customer.profile_edit')); ?>" class="bilai-dash-nav-item active">
                        ...
                        <form id="bilai-prof-logout-form" action="<?php echo e(route('customer.logout')); ?>" method="POST" style="display:none;"><?php echo csrf_field(); ?></form>
                    </nav>
                </div>
            </aside>
            ...
            <main>
                <div class="bilai-prof-card">
                    ...
                    <form action="<?php echo e(route('customer.profile_update')); ?>" method="POST" enctype="multipart/form-data" id="bilai-prof-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="bilai-prof-avatar-wrap">
                            <div class="bilai-prof-avatar-box">
                                <?php if($profileImage): ?>
                                    <img id="bilai-prof-avatar-img" src="<?php echo e($profileImage); ?>" class="bilai-prof-avatar-img" alt="Profile picture"
                                         onerror="this.style.display='none';document.getElementById('bilai-prof-avatar-fallback').style.display='flex';">
                                    <div id="bilai-prof-avatar-fallback" class="bilai-prof-avatar-fallback" style="display:none;"><?php echo e($customerInitial); ?></div>
                                <?php else: ?>
                                    <img id="bilai-prof-avatar-img" src="" class="bilai-prof-avatar-img" alt="Profile picture" style="display:none;">
                                    <div id="bilai-prof-avatar-fallback" class="bilai-prof-avatar-fallback"><?php echo e($customerInitial); ?></div>
                                <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?><p class="bilai-prof-err"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('name', $profile_edit->name)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('phone', $profile_edit->phone)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('email', $profile_edit->email)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('address', $profile_edit->address)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="bilai-prof-field">
                                ...
                                <select name="district_id" id="bilai-prof-district" required
                                        class="<?php $__errorArgs = ['district_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($district->id); ?>" <?php if((string) $selectedDistrict === (string) $district->id): echo 'selected'; endif; ?>><?php echo e($district->name); ?></option>
...
(function () {
    ...
    $(function () {
        window.BilaiDistrictZone.initFields({
            ...
            selectedZone: <?php echo json_encode($selectedZone, 15, 512) ?>,
            fresh:        true
        });
    });
}());
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\profile_edit.blade.php ENDPATH**/ ?>