...
<?php $__env->startSection('title','Add Life Stage'); ?>
...
<div class="container-fluid">
    <div class="row"><div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between py-4">
            <div><h4 class="page-title mb-1 text-dark fw-bold">Add Life Stage</h4><p class="text-muted font-size-13 mb-0">Add a new product weight (e.g., e.g. Adult, Kitten, Senior).</p></div>
            <a href="<?php echo e(route('lifestages.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4"><i class="fe-arrow-left me-1"></i> Back to List</a>
        </div>
    </div></div>
    <form action="<?php echo e(route('lifestages.store')); ?>" method="POST" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. e.g. Adult, Kitten, Senior" required>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded border border-light">
                            <div><h6 class="mb-1 text-dark fw-bold">Active Status</h6><p class="text-muted font-size-12 mb-0">Show this life stage in product filters</p></div>
...
unset($__errorArgs, $__bag); ?>
                        <button type="submit" class="btn btn-submit w-100 rounded-pill"><i class="fe-check-circle me-1"></i> Save Life Stage</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\lifestage\create.blade.php ENDPATH**/ ?>