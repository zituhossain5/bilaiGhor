...
<head>
    ...
    <title><?php echo e($category->name); ?> | <?php echo e($landing->title); ?></title>
    ...
    <div class="container mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
            ...
            <ul class="space-y-1 text-sm font-medium">
                <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="border-b border-gray-100 last:border-0">
                        <div class="flex items-center">
                            <a href="<?php echo e($categoryRoute($cat)); ?>" class="flex-1 flex items-center py-3 hover:text-blue-600 <?php echo e(($category->id ?? null) == $cat->id ? 'text-blue-600 font-bold' : ''); ?>">
                            ...
                            <?php if($cat->subcategories && $cat->subcategories->count() > 0): ?>
                                <button type="button" onclick="toggleSubcat('cat-<?php echo e($cat->id); ?>', this)" class="p-2 text-gray-400 hover:text-blue-600">
                                    <i class="fa-solid fa-chevron-right text-xs cat-toggle-icon"></i>
                                </button>
                            <?php endif; ?>
                        </div>
                        <?php if($cat->subcategories && $cat->subcategories->count() > 0): ?>
                            <ul id="cat-<?php echo e($cat->id); ?>" class="ml-11 mb-2 space-y-0.5 <?php echo e(($category->id ?? null) == $cat->id ? '' : 'hidden'); ?>">
                                <?php $__currentLoopData = $cat->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e($subcategoryRoute($sub)); ?>" class="block py-1.5 px-2 rounded hover:bg-blue-50 hover:text-blue-600 text-xs"><?php echo e($sub->subcategoryName ?? $sub->name); ?></a></li>
        ...
        <main class="flex-1">
            <div class="bg-white rounded-xl shadow p-4 md:p-6 mb-6">
                <h1 class="text-xl md:text-2xl font-bold text-gray-800 border-b-4 border-blue-600 inline-block pb-1"><?php echo e($category->name); ?></h1>
            ...
            <?php else: ?>
                <div class="bg-white rounded-xl shadow p-12 text-center text-gray-500">
                    ...
                    <p>এই ক্যাটাগরিতে কোন প্রোডাক্ট নেই।</p>
        ...
        <ul class="py-2">
            <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="border-b">
                    ...
                    <?php if($cat->subcategories && $cat->subcategories->count() > 0): ?>
                        <button type="button" onclick="event.stopPropagation();toggleSubcat('mcat-<?php echo e($cat->id); ?>',this)" class="p-3"><i class="fa-solid fa-chevron-right text-xs"></i></button>
                    <?php endif; ?></div>
                    <?php if($cat->subcategories && $cat->subcategories->count() > 0): ?>
                        <ul id="mcat-<?php echo e($cat->id); ?>" class="bg-gray-50 hidden">
                            <?php $__currentLoopData = $cat->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\landing\category.blade.php ENDPATH**/ ?>