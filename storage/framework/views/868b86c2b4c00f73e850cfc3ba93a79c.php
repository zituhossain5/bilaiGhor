...
<script>
    ...
    $(document).ready(function() {
        ...
        const hasAdvance = <?php echo json_encode($hasAdvance ?? false, 15, 512) ?>;
...
(function () {
    ...
    var hasAdvance = <?php echo json_encode($hasAdvance, 15, 512) ?>;
    var advanceAmount = parseFloat("<?php echo e($advance_amount); ?>") || 0;
