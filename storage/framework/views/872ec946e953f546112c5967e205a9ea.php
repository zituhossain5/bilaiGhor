...
<?php $__env->startSection('title', 'My Addresses | ' . ($customer->name ?? 'Account')); ?>
...
<div class="bilai-adr-page">
    <div class="container">
        ...
        <nav class="bilai-adr-bc" aria-label="breadcrumb">
            ...
            <a href="<?php echo e(route('customer.account')); ?>">Account</a>
            <span class="bilai-adr-bc-sep">›</span>
        ...
        <div class="bilai-adr-layout">
            ...
            <aside class="bilai-adr-sidebar">
                ...
                <div class="bilai-card">
                    <nav class="bilai-dash-nav">
                        ...
                        <a href="<?php echo e(route('customer.addresses')); ?>" class="bilai-dash-nav-item active">
                        ...
                        <form id="bilai-adr-logout-form" action="<?php echo e(route('customer.logout')); ?>" method="POST" style="display:none;"><?php echo csrf_field(); ?></form>
                    </nav>
                </div>
            </aside>
            ...
            <main class="bilai-adr-app" id="bilai-adr-app">
                ...
                <?php if($addresses->count() > 0): ?>
                        ...
                        <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bilai-adr-card">
                                <div class="bilai-adr-card-head">
                                    <p class="bilai-adr-card-title">Address <?php echo e($i + 1); ?></p>

                                    
                                    <div class="bilai-adr-actions">
                                        <form action="<?php echo e(route('customer.addresses.delete', $addr->id)); ?>" method="POST"
                                        ...
                                        <button type="button" class="bilai-adr-btn-edit bilai-afm-edit-open"
                                                ...
                                                data-mobile="<?php echo e($addr->phone); ?>"
                                    ...
                                    <input type="radio" class="bilai-adr-radio" name="default_address_radio"
                                           value="<?php echo e($addr->id); ?>"
                                           data-default="<?php echo e($addr->is_default ? '1' : '0'); ?>"
                                           <?php if($addr->is_default): echo 'checked'; endif; ?>
                                           aria-label="Select as default address">
                                </div>
                                <div class="bilai-adr-card-body">
                                    <p class="bilai-adr-line name"><?php echo e($addr->name); ?></p>
                                    <p class="bilai-adr-line muted"><?php echo e($addr->address); ?></p>
                                    ...
                                    ?>
                                    <?php if(!empty($addrLocation)): ?>
                                        <p class="bilai-adr-line muted"><?php echo e(implode(', ', $addrLocation)); ?></p>
                                    <?php endif; ?>
                                    <?php if($addr->post_code): ?>
                                        <p class="bilai-adr-line muted">Post Code: <?php echo e($addr->post_code); ?></p>
                                    <?php endif; ?>
                                    <p class="bilai-adr-line muted"><?php echo e($addr->phone); ?></p>
                                    <?php if($addr->email): ?>
                                        <p class="bilai-adr-line muted"><?php echo e($addr->email); ?></p>
                                    <?php endif; ?>
                                    <div class="bilai-adr-tags">
                                        <?php if($addr->label): ?>
                                            <span class="bilai-adr-tag-type">
                                                
                                                <i class="fa <?php echo e(strtolower($addr->label) === 'office' ? 'fa-briefcase' : 'fa-home'); ?>"></i>
                                                <?php echo e($addr->label); ?>
                    ...
                    <form id="bilai-adr-default-form" action="<?php echo e(route('customer.addresses.default')); ?>" method="POST" style="display:none;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views/frontEnd/layouts/customer/addresses.blade.php ENDPATH**/ ?>