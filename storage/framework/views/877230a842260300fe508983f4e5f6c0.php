...
<div style="background:#fff; width:90%;margin:0 auto !important">
    ...
    <table class="body-wrap" style="background:#fff; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 16px; width: 100%; margin: 0;padding:0 30px">
        <tbody style="background:#fff">
            ...
            <tr>
                <td style="padding:30px 0;border:0">Thanks — we've successfully delivered your order ID #<?php echo e($order->invoice_id); ?>. Please follow these notes about your order.</td></br>
            </tr>
             <tr>
                <td style="padding:15px;border:2px solid #ddd"><?php echo $order->admin_note; ?></td></br>
            </tr>
        </tbody>
    </table>
</table>
...
</html><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\emails\order_delivered.blade.php ENDPATH**/ ?>