...
<?php $__env->startSection('title','View Role'); ?>
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <h2 class="role-title"><?php echo e($role->name); ?></h2>
                        <span class="badge bg-dark rounded-pill px-3">ID: #<?php echo e($role->id); ?></span>
                    </div>
                                ...
                                <?php if(!empty($rolePermissions) && count($rolePermissions) > 0): ?>
                                    <?php $__currentLoopData = $rolePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="permission-badge">
                                            <i class="fe-check-circle me-1"></i> <?php echo e($v->name); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\roles\show.blade.php ENDPATH**/ ?>