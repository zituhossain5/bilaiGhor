    ...
    <div class="container">
        ...
        <div class="bilai-od-layout">
            ...
            <aside class="bilai-od-sidebar">
                ...
                <div class="bilai-card">
                    <nav class="bilai-od-nav">
                        ...
                        <a href="<?php echo e(route('customer.wishlist')); ?>" class="bilai-od-nav-item">
            ...
            <main class="bilai-od-content">
                ...
                <div class="bilai-card">
                    <div class="bilai-od-cardbody">
                        <div class="bilai-od-card-head">
                            ...
                            <?php if($trackingUrl): ?>
                                <a href="<?php echo e($trackingUrl); ?>" target="_blank" rel="noopener noreferrer" class="bilai-od-btn bilai-od-btn--soft">
                ...
                <div class="bilai-od-2col <?php echo e($hasCourierInfo ? '' : 'bilai-od-2col--single'); ?>">
                        ...
                        <div class="bilai-card">
                            <div class="bilai-od-cardbody">
                                ...
                                <div class="bilai-od-info-row">
                                    ...
                                    <div>
                                        <p class="bilai-od-info-name"><?php echo e($courierName ?? 'Courier'); ?></p>
                                        <?php if($trackingId): ?>
                                            <p class="bilai-od-info-line">Tracking: <?php echo e($trackingId); ?></p>
                                        <?php else: ?>
                                            <p class="bilai-od-info-line">Tracking information is not available yet.</p>
                                        <?php endif; ?>
                                        <?php if($order->courier_sent_at): ?>
                                            <p class="bilai-od-info-line">Sent: <?php echo e(\Carbon\Carbon::parse($order->courier_sent_at)->format('M d, Y')); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\order_details.blade.php ENDPATH**/ ?>