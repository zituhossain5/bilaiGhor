...
<?php $__env->startSection('title', 'বিভাগ এডিট'); ?>
<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-body">
            <h5 class="mb-3">বিভাগ এডিট</h5>
            <form action="<?php echo e(route('admin.delivery.divisions.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\delivery\division_edit.blade.php ENDPATH**/ ?>