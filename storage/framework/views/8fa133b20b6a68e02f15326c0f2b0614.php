...
<section class="ba-section">
    <div class="ba-card">
        ...
        <div class="ba-tabs">
            <a href="<?php echo e(route('customer.login')); ?>" class="ba-tab">Login</a>
            <a href="<?php echo e(route('customer.register')); ?>" class="ba-tab active">Register</a>
        </div>
        ...
        <form action="<?php echo e(route('customer.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="ba-field">
                ...
                <input type="text" id="name" name="name"
                       class="ba-input no-icon <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('name', session('social_name', ''))); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="ba-field">
                ...
                <input type="text" id="phone" name="phone"
                       class="ba-input no-icon <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" name="email" value="<?php echo e(old('email', session('social_email', ''))); ?>">
            ...
            <div class="ba-field">
                ...
                <div class="ba-pw-wrap">
                    <input type="password" id="password_confirmation" name="password_confirmation"
                           class="ba-input <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\register.blade.php ENDPATH**/ ?>