...
.mobile-search form {
    ...
    border: 1px solid;
    border-radius: 5px;
    background-color: <?php echo e($generalsetting->secodery_color); ?>;
    height: 40px;
    overflow: hidden;
    position: relative;
...
}<?php /**PATH C:\laragon\www\bilaiGhor\resources\views/frontEnd/assets/responsive.blade.php ENDPATH**/ ?>