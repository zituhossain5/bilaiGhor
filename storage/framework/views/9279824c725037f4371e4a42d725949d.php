...
<?php $__env->startSection('title', 'অর্ডার'); ?>
<?php $__env->startSection('header_title', 'অসম্পূর্ণ ডেলিভারি'); ?>
...
<div class="d-link-top">
    <a href="<?php echo e(route('delivery.orders.history')); ?>">সম্পন্ন ডেলিভারি দেখুন →</a>
</div>
...
<?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <div class="d-card d-card--flush mb-3">
        <a href="<?php echo e(route('delivery.orders.show', $o->id)); ?>" class="d-list-link" style="padding:16px 16px 10px;">
            ...
            <small class="d-muted-small" style="display:block;margin-top:6px;line-height:1.45;"><?php echo e(\Illuminate\Support\Str::limit($o->shipping->address ?? '—', 120)); ?></small>
        </a>
        <?php if($customerPhone): ?>
            <div class="d-order-list-actions">
                <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $customerPhone)); ?>" class="d-call-btn">
...
<?php echo $__env->make('delivery.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\delivery\orders\index.blade.php ENDPATH**/ ?>