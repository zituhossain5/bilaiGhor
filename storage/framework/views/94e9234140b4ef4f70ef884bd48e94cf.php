...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('banner_category.create')); ?>" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end">
                                        <a href="<?php echo e(route('banner_category.edit',$value->id)); ?>" class="btn-action btn-edit" title="Edit">
                                            <i class="fe-edit-1" style="font-size: 16px;"></i>
                                        </a>

                                        <form action="<?php echo e(route('banner_category.destroy')); ?>" method="POST" class="delete-form d-inline">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\banner\category\index.blade.php ENDPATH**/ ?>