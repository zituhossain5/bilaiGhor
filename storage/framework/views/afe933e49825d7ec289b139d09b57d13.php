...
<?php $__env->startSection('title','Edit Weight'); ?>
...
<div class="container-fluid">
    <div class="row"><div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between py-4">
            <div><h4 class="page-title mb-1 text-dark fw-bold">Edit Weight</h4></div>
    ...
    <form action="<?php echo e(route('weights.update')); ?>" method="POST" data-parsley-validate>
        <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-submit w-100 rounded-pill"><i class="fe-check-circle me-1"></i> Update Weight</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\weight\edit.blade.php ENDPATH**/ ?>