...
<div style="background:#fff; width:90%;margin:0 auto !important">
        ...
        <tbody style="background:#4DBC60;">
            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 25px; margin: 0;border:0">
                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                   <h3 style="color:#fff;text-align:center;padding:20px 0">Your Order Number: #<?php echo e($order->invoice_id); ?></h3>
                 </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody style="background:#fff">
            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;border:0">
                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; padding-top: 15px;">
                    Hi Dear <strong><?php echo e($order->shipping?$order->shipping->name:''); ?></strong>
                 </td>
            </tr>
            <tr>
                <td style="padding:30px 0;border:0">Thanks — Your order was placed successfully. Order ID #<?php echo e($order->invoice_id); ?>. You will receive a processing email as soon as possible. or check the status of your order from <a href="https://giftshopbd.websolutionit.com/customer/orders" style="font-weight:900;color:blue">here</a></td></br>
            </tr>
        </tbody>
    </table>
    ...
    <table style="padding:10px 0px;margin-bottom:25px;text-align:center !important;width:100%">
        <tbody>
            ...
            <tr><td><?php echo e($order->shipping?$order->shipping->name:''); ?></td></tr>
            <tr><td><?php echo e($order->shipping?$order->shipping->phone:''); ?></td></tr>
            <tr><td><?php echo e($order->shipping?$order->shipping->email:''); ?></td></tr>
        </tbody>
    </table>
        ...
        <tbody style="background:#4DBC60;">
            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box;  margin: 0;border:0">
                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; margin: 0;">
                   <p style="color:#fff;text-align:center;padding:20px 0;font-size:15px;letter-spacing:2px">@copyright <?php echo e(date('Y')); ?> Giftshopbd</p>
                 </td>
            </tr>
        </tbody>
    </table>
...
</html><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\emails\order_place.blade.php ENDPATH**/ ?>