...
<title>New Order #<?php echo e($order->invoice_id); ?></title>
</head>
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.09);">
        ...
        <tr>
          ...
          <td align="right" valign="top">
            <div style="background:#f0f0ff;border:1px solid #c7d2fe;border-radius:8px;padding:10px 18px;display:inline-block;text-align:center;">
              ...
              <p style="margin:2px 0 0;font-size:18px;font-weight:800;color:#1e1b4b;">#<?php echo e($order->invoice_id); ?></p>
            </div>
          </td>
        </tr>
      </table>
            ...
            <table cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td>
                  ...
                  <p style="margin:2px 0 0;font-size:12px;color:#6b7280;"><?php echo e($order->created_at->format('l, d F Y — h:i A')); ?></p>
                </td>
              </tr>
            </table>
          </td>
          ...
          <td width="48%" valign="top" style="padding-right:8px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
              <tr style="border-bottom:1px solid #e5e7eb;">
                ...
                <td style="padding:10px 14px;font-size:12px;font-weight:600;color:#1f2937;text-align:right;text-transform:uppercase;"><?php echo e($order->payment->payment_method ?? 'N/A'); ?></td>
              </tr>
              <tr style="border-bottom:1px solid #e5e7eb;">
          ...
          <td width="48%" valign="top" style="padding-left:8px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
              <tr style="border-bottom:1px solid #e5e7eb;">
                ...
                <td style="padding:10px 14px;font-size:12px;font-weight:600;color:#1f2937;text-align:right;"><?php echo e($shipping->name ?? ($customer->name ?? 'N/A')); ?></td>
              </tr>
              <tr style="border-bottom:1px solid #e5e7eb;">
                <td style="padding:10px 14px;font-size:12px;color:#6b7280;">Phone</td>
                <td style="padding:10px 14px;font-size:12px;font-weight:600;color:#1f2937;text-align:right;"><?php echo e($shipping->phone ?? ($customer->phone ?? 'N/A')); ?></td>
              </tr>
              <tr>
                <td style="padding:10px 14px;font-size:12px;color:#6b7280;">Area</td>
                <td style="padding:10px 14px;font-size:12px;font-weight:600;color:#1f2937;text-align:right;"><?php echo e($shipping->area ?? 'N/A'); ?></td>
              </tr>
            </table>
          </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#fffbeb;border:1px solid #fde68a;border-radius:8px;">
        <tr>
          <td style="padding:12px 18px;">
            ...
            <p style="margin:0;font-size:13px;color:#1f2937;"><?php echo e($shipping->address); ?><?php if(!empty($shipping->area)): ?>, <?php echo e($shipping->area); ?><?php endif; ?></p>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td style="padding:0 48px 24px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
        ...
        <tbody>
          ...
          <tr style="background:<?php echo e($loop->even ? '#f9fafb' : '#ffffff'); ?>;border-top:1px solid #e5e7eb;">
            <td style="padding:12px 16px;font-size:13px;color:#374151;font-weight:500;"><?php echo e($item->product_name); ?></td>
            <td style="padding:12px 16px;font-size:13px;color:#6b7280;text-align:center;"><?php echo e($item->qty); ?></td>
            <td style="padding:12px 16px;font-size:13px;color:#6b7280;text-align:right;">৳<?php echo e(number_format($item->sale_price, 0)); ?></td>
            <td style="padding:12px 16px;font-size:13px;color:#1f2937;font-weight:600;text-align:right;">৳<?php echo e(number_format($item->qty * $item->sale_price, 0)); ?></td>
          </tr>
          ...
          <td align="right">
            <table cellpadding="0" cellspacing="0" style="min-width:260px;">
              <tr>
                ...
                <td style="padding:6px 0;font-size:13px;color:#374151;text-align:right;">৳<?php echo e(number_format($order->amount - $order->shipping_charge - ($order->discount ?? 0), 0)); ?></td>
              </tr>
              <?php if($order->shipping_charge > 0): ?>
              <tr>
                <td style="padding:6px 0;font-size:13px;color:#6b7280;padding-right:24px;">Shipping Charge</td>
                <td style="padding:6px 0;font-size:13px;color:#374151;text-align:right;">৳<?php echo e(number_format($order->shipping_charge, 0)); ?></td>
              </tr>
              <?php endif; ?>
              <?php if(($order->discount ?? 0) > 0): ?>
              <tr>
                <td style="padding:6px 0;font-size:13px;color:#059669;padding-right:24px;">Discount</td>
                <td style="padding:6px 0;font-size:13px;color:#059669;text-align:right;">-৳<?php echo e(number_format($order->discount, 0)); ?></td>
              </tr>
              <?php endif; ?>
              <tr>
              ...
              <tr style="background:#f0f0ff;border-radius:6px;">
                ...
                <td style="padding:10px 16px;font-size:18px;font-weight:800;color:#4f46e5;text-align:right;">৳<?php echo e(number_format($order->amount, 0)); ?></td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;">
        <tr>
          <td style="padding:12px 18px;">
            ...
            <p style="margin:0;font-size:13px;color:#374151;"><?php echo e($order->note); ?></p>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td style="padding:0 48px 40px;text-align:center;">
      <a href="<?php echo e(url('admin/order/all')); ?>"
      ...
      <p style="margin:12px 0 0;font-size:12px;color:#9ca3af;">
        Or copy: <span style="color:#4f46e5;"><?php echo e(url('admin/order/all')); ?></span>
      </p>
    </td>
  </tr>
        ...
        <tr>
          <td>
            <p style="margin:0;font-size:12px;color:#9ca3af;">
              <strong style="color:#6b7280;"><?php echo e(config('app.name')); ?></strong> — Automated Order Notification
            </p>
          </td>
          <td align="right">
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\emails\order_place_for_admin.blade.php ENDPATH**/ ?>