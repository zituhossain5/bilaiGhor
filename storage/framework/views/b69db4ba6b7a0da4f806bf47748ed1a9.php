...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('manual-payment-gateway.manage')); ?>" class="btn btn-outline-primary btn-sm">
            ম্যানুয়াল পেমেন্ট
        </a>
    </div>
            ...
            <div class="card gateway-card">
                <div class="card-header-custom header-bkash">
                    ...
                    <div class="gateway-icon-box">
                        <img src="<?php echo e(asset('public/frontEnd/images/bkash.svg')); ?>" alt="bKash">
                    </div>
                </div>
                
                <div class="card-body p-4">
                    <form action="<?php echo e(route('paymentgeteway.update')); ?>" method="POST" data-parsley-validate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="username" value="<?php echo e($bkash->username); ?>" required />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Password</label>
                                <input type="text" class="form-control" name="password" value="<?php echo e($bkash->password); ?>" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="app_key" value="<?php echo e($bkash->app_key); ?>" required />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">App Secret</label>
                                <input type="text" class="form-control" name="app_secret" value="<?php echo e($bkash->app_secret); ?>" required />
                            </div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Base URL</label>
                            <input type="text" class="form-control" name="base_url" value="<?php echo e($bkash->base_url); ?>" required />
                        </div>
                        ...
                        <div class="status-wrapper">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" value="1" <?php if($bkash->status==1): ?> checked <?php endif; ?> style="cursor: pointer; width: 3em; height: 1.5em;">
                            </div>
                        </div>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card gateway-card">
                <div class="card-header-custom header-shurjo">
                    ...
                    <div class="gateway-icon-box">
                        <img src="<?php echo e(asset('public/frontEnd/images/shurjoPay.png')); ?>" alt="ShurjoPay">
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('paymentgeteway.update')); ?>" method="POST" data-parsley-validate>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">User Name</label>
                                <input type="text" class="form-control" name="username" value="<?php echo e($shurjopay->username); ?>" required />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Prefix</label>
                                <input type="text" class="form-control" name="prefix" value="<?php echo e($shurjopay->prefix); ?>" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Password</label>
                                <input type="text" class="form-control" name="password" value="<?php echo e($shurjopay->password); ?>" required />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Base URL</label>
                                <input type="text" class="form-control" name="base_url" value="<?php echo e($shurjopay->base_url); ?>" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control" name="success_url" value="<?php echo e($shurjopay->success_url); ?>" required />
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label">Return URL</label>
                                <input type="text" class="form-control" name="return_url" value="<?php echo e($shurjopay->return_url); ?>" required />
                            </div>
                        </div>
                        ...
                        <div class="status-wrapper">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" value="1" <?php if($shurjopay->status==1): ?> checked <?php endif; ?> style="cursor: pointer; width: 3em; height: 1.5em;">
                            </div>
                        </div>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card gateway-card">
                <div class="card-header-custom header-uddokta">
                    ...
                    <div class="gateway-icon-box">
                        <img src="<?php echo e(asset('public/frontEnd/images/uddokta.png')); ?>" alt="Uddokta">
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('paymentgeteway.update')); ?>" method="POST" data-parsley-validate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="app_key" value="<?php echo e($uddoktapay->app_key ?? ''); ?>" placeholder="UDDOKTAPAY_API_KEY" required />
                        </div>

                        <div class="mb-4">
                            <label class="form-label">API Base URL</label>
                            <input type="text" class="form-control" name="base_url" value="<?php echo e($uddoktapay->base_url ?? 'https://sandbox.uddoktapay.com/api/checkout-v2'); ?>" placeholder="UDDOKTAPAY_API_URL" required />
                        </div>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card gateway-card">
                <div class="card-header-custom header-aamarpay">
                    ...
                    <div class="gateway-icon-box">
                   <img src="<?php echo e(asset('public/frontEnd/images/aamarpay.png')); ?>" alt="Uddokta">
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('paymentgeteway.update')); ?>" method="POST" data-parsley-validate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="app_key" value="<?php echo e($aamarpay->app_key ?? ''); ?>" placeholder="aamarpaytest (Sandbox)" required />
                            <small class="text-muted">Store ID is stored in App Key field</small>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Signature Key</label>
                            <input type="text" class="form-control" name="app_secret" value="<?php echo e($aamarpay->app_secret ?? ''); ?>" placeholder="dbb74894e82415a2f7ff0ec3a97e4183 (Sandbox)" required />
                            <small class="text-muted">Signature Key is stored in App Secret field</small>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">API Base URL</label>
                            <input type="text" class="form-control" name="base_url" value="<?php echo e($aamarpay->base_url ?? 'https://sandbox.aamarpay.com/jsonpost.php'); ?>" placeholder="https://sandbox.aamarpay.com/jsonpost.php" required />
                        ...
                        <div class="status-wrapper">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" value="1" 
                                       <?php if(isset($aamarpay) && $aamarpay->status == 1): ?> checked <?php endif; ?> 
                                       style="cursor: pointer; width: 3em; height: 1.5em;">
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views/backEnd/apiintegration/pay_manage.blade.php ENDPATH**/ ?>