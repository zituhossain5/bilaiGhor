    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-md-12">
            ...
            <div class="studio-card p-4">
                <form action="<?php echo e(route('pages.store')); ?>" method="POST" id="pageCreateForm" data-parsley-validate="" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\createpage\create.blade.php ENDPATH**/ ?>