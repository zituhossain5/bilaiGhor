...
<?php $__env->startSection('title','Wholesale Products'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-lg-4 col-md-5 mt-2 mt-md-0">
                            <form method="GET" action="<?php echo e(route('admin.products.wholesale')); ?>">
                                <div class="row g-2">
                                    <div class="col-12">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input product-checkbox" type="checkbox" value="<?php echo e($product->id); ?>" name="product_ids[]">
                                        </div>
                                    </td>
                                    <td>
                                        <img src="<?php echo e(asset($product->image ? $product->image->image : 'public/uploads/default/no-image.png')); ?>" 
                                             alt="<?php echo e($product->name); ?>" 
                                             class="product-img" 
                                             style="width: 50px; height: 50px;">
                                    </td>
                                    <td>
                                        <p class="product-title mb-1"><?php echo e(Str::limit($product->name, 40)); ?></p>
                                        <small class="text-muted text-small">SKU: <?php echo e($product->sku ?? 'N/A'); ?></small>
                                    </td>
                                    <td>
                                        <span class="badge badge-soft-info"><?php echo e($product->category->name ?? 'N/A'); ?></span>
                                    </td>
                                    <td>
                                        <?php if($product->vendor): ?>
                                            <span class="badge badge-soft-primary"><?php echo e($product->vendor->shop_name ?? 'Vendor #' . $product->vendor_id); ?></span>
                                        <?php else: ?>
                                            <span class="badge badge-soft-secondary">Inhouse</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($product->wholesalePrices && $product->wholesalePrices->count() > 0): ?>
                                            <span class="badge badge-soft-success"><?php echo e($product->wholesalePrices->count()); ?> Tier(s)</span>
                                        <?php else: ?>
                                            <span class="badge badge-soft-warning">No Tiers</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <strong class="text-primary">৳<?php echo e(number_format($product->new_price, 2)); ?></strong>
                                        <?php if($product->old_price && $product->old_price > $product->new_price): ?>
                                            <br><small class="text-muted text-decoration-line-through">৳<?php echo e(number_format($product->old_price, 2)); ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="badge <?php echo e($product->stock > 0 ? 'badge-soft-success' : 'badge-soft-danger'); ?>">
                                            <?php echo e($product->stock ?? 0); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge <?php echo e($product->status == 1 ? 'badge-soft-success' : 'badge-soft-danger'); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="<?php echo e(route('products.show', $product->id)); ?>" class="btn btn-sm btn-action btn-edit" title="View">
                                                <i class="fe-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="btn btn-sm btn-action btn-edit" title="Edit">
                                                <i class="fe-edit"></i>
                                            </a>
                                        </div>
                                    </td>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\product\wholesale.blade.php ENDPATH**/ ?>