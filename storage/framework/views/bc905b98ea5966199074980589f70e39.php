...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('permissions.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="permission-name">
                                        <i class="fe-lock permission-icon"></i> <?php echo e($value->name); ?>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('permissions.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit Permission">
                                            <i class="fe-edit"></i>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\permissions\index.blade.php ENDPATH**/ ?>