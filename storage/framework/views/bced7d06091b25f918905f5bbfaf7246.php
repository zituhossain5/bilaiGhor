...
<?php $__env->startSection('title','Edit TikTok Pixel'); ?>
...
<div class="container-fluid">
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="page-title mb-0" style="font-weight: 700; color: #2d3436;">Edit TikTok Pixel</h4>
                <p class="text-muted font-size-13 mb-0">Update TikTok tracking pixel configuration.</p>
            </div>
            <a href="<?php echo e(route('tiktok.pixels.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">Update TikTok Pixel</h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('tiktok.pixels.update')); ?>" method="POST" data-parsley-validate>
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\tiktok_pixels\edit.blade.php ENDPATH**/ ?>