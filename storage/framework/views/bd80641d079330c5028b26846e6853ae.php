...
<?php $__env->startSection('title', 'ল্যান্ডিং পেজ সেটিংস'); ?>
<?php $__env->startSection('page-title', 'ল্যান্ডিং পেজ'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('reseller.landing.products')); ?>" class="btn btn-success">
                <i class="fas fa-box me-2"></i> প্রোডাক্ট ম্যানেজ করুন
            </a>
            <a href="<?php echo e($landingUrl); ?>" target="_blank" class="btn btn-primary">
    ...
    <form action="<?php echo e(route('reseller.landing.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><?php echo e(url('/r/')); ?>/</span>
                                    <input type="text" name="slug" class="form-control form-control-custom" value="<?php echo e(old('slug', $landing->slug)); ?>" placeholder="my-store" pattern="[a-z0-9\-]+" required>
                                </div>
                                <small class="text-muted">শুধু ইংরেজি অক্ষর, সংখ্যা ও হাইফেন। লিঙ্ক: <?php echo e(url('/r')); ?>/<strong><?php echo e($landing->slug); ?></strong></small>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom">কাস্টম ডোমেইন (ঐচ্ছিক)</label>
                                <input type="text" name="custom_domain" class="form-control form-control-custom" value="<?php echo e(old('custom_domain', $landing->custom_domain)); ?>" placeholder="shop.example.com">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control form-control-custom" value="<?php echo e(old('title', $landing->title)); ?>" placeholder="আমার স্টোর">
                            </div>
                            <div class="col-12">
                                <label class="form-label-custom">ট্যাগলাইন (ঐচ্ছিক)</label>
                                <input type="text" name="tagline" class="form-control form-control-custom" value="<?php echo e(old('tagline', $landing->tagline)); ?>" placeholder="আপনার বিশ্বস্ত শপিং পার্টনার">
                            </div>
                            <div class="col-12">
                                <label class="form-label-custom">স্ক্রলিং টেক্সট (ন্যাভ বার এ)</label>
                                <input type="text" name="scrolling_text" class="form-control form-control-custom" value="<?php echo e(old('scrolling_text', $landing->scrolling_text ?? '')); ?>" placeholder="উদাহরণ: বিনামূল্যে ডেলিভারি | নতুন অফার আসছে | কল করুন: ০১৭৭৫৪৫৭০০৮">
                    ...
                    <div class="landing-card-body">
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <?php if($landing->favicon ?? null): ?>
                                    <div class="mb-2"><img src="<?php echo e(asset($landing->favicon)); ?>" class="img-preview" style="max-height:48px;max-width:48px;" alt="Favicon"></div>
                                <?php endif; ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($landing->logo): ?>
                                    <div class="mb-2"><img src="<?php echo e(asset($landing->logo)); ?>" class="img-preview" alt="Logo"></div>
                                <?php endif; ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if($landing->banner_image): ?>
                                    <div class="mb-2"><img src="<?php echo e(asset($landing->banner_image)); ?>" class="img-preview" alt="Banner"></div>
                                <?php endif; ?>
                                    ...
                                    <div class="mb-3">
                                        <?php $__currentLoopData = $landing->slider_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="slider-item">
                                                <img src="<?php echo e(asset($img)); ?>" alt="Slider">
                    ...
                    <div class="landing-card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone" class="form-control form-control-custom" value="<?php echo e(old('phone', $landing->phone)); ?>" placeholder="017xxxxxxxx">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom">ইমেইল</label>
                                <input type="email" name="email" class="form-control form-control-custom" value="<?php echo e(old('email', $landing->email)); ?>" placeholder="email@example.com">
                            </div>
                            <div class="col-12">
                                <label class="form-label-custom">ঠিকানা</label>
                                <textarea name="address" class="form-control form-control-custom" rows="3" placeholder="সম্পূর্ণ ঠিকানা"><?php echo e(old('address', $landing->address)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" name="show_social_footer" value="1" id="showSocial" <?php echo e(($landing->show_social_footer ?? 1) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="url" name="facebook_url" class="form-control form-control-custom" value="<?php echo e(old('facebook_url', $landing->facebook_url ?? '')); ?>" placeholder="https://facebook.com/yourpage">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom">Twitter / X URL</label>
                                <input type="url" name="twitter_url" class="form-control form-control-custom" value="<?php echo e(old('twitter_url', $landing->twitter_url ?? '')); ?>" placeholder="https://twitter.com/yourpage">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom">WhatsApp (লিংক বা নম্বর)</label>
                                <input type="text" name="whatsapp_url" class="form-control form-control-custom" value="<?php echo e(old('whatsapp_url', $landing->whatsapp_url ?? '')); ?>" placeholder="https://wa.me/88017xxxxxxxx">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom">YouTube URL</label>
                                <input type="url" name="youtube_url" class="form-control form-control-custom" value="<?php echo e(old('youtube_url', $landing->youtube_url ?? '')); ?>" placeholder="https://youtube.com/@yourchannel">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom">Instagram URL</label>
                                <input type="url" name="instagram_url" class="form-control form-control-custom" value="<?php echo e(old('instagram_url', $landing->instagram_url ?? '')); ?>" placeholder="https://instagram.com/yourpage">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="landing-card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="facebook_pixel_id" class="form-control form-control-custom" value="<?php echo e(old('facebook_pixel_id', $landing->facebook_pixel_id ?? '')); ?>" placeholder="1234567890123456">
                            </div>
                            <div class="col-12">
                                <label class="form-label-custom">Google Tag Manager (GTM) ID</label>
                                <input type="text" name="gtm_id" class="form-control form-control-custom" value="<?php echo e(old('gtm_id', $landing->gtm_id ?? '')); ?>" placeholder="GTM-XXXXXXX">
                            </div>
                            <div class="col-12">
                                <label class="form-label-custom">TikTok Pixel ID</label>
                                <input type="text" name="tiktok_pixel_id" class="form-control form-control-custom" value="<?php echo e(old('tiktok_pixel_id', $landing->tiktok_pixel_id ?? '')); ?>" placeholder="XXXXXXXXXXXXXXXX">
                            </div>
                            <div class="col-12">
                                <label class="form-label-custom">Facebook Conversion API Access Token (ঐচ্ছিক)</label>
                                <input type="text" name="facebook_capi_access_token" class="form-control form-control-custom" value="<?php echo e(old('facebook_capi_access_token', $landing->facebook_capi_access_token ?? '')); ?>" placeholder="Server-side events এর জন্য">
                ...
                <div class="landing-card">
                    ...
                    <div class="landing-card-body">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="show_newsletter_footer" value="1" id="showNewsletter" <?php echo e(($landing->show_newsletter_footer ?? 1) ? 'checked' : ''); ?>>
                ...
                <div class="landing-card">
                    ...
                    <div class="landing-card-body">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" id="isActive" <?php echo e(($landing->is_active ?? 1) ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="isActive">ল্যান্ডিং পেজ সক্রিয়</label>
                        </div>
                        <a href="<?php echo e($landingUrl); ?>" target="_blank" class="btn btn-outline-primary w-100 mb-2">
...
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\landing\index.blade.php ENDPATH**/ ?>