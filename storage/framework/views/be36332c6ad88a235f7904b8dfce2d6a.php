...
<?php $__env->startSection('title','Add Flavor'); ?>
...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('flavors.store')); ?>" method="POST" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. e.g. Beef, Chicken, Salmon" required>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\flavor\create.blade.php ENDPATH**/ ?>