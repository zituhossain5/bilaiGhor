...
<head>
    ...
    <title>রিফান্ড বিস্তারিত #<?php echo e($refund->refund_id); ?> | <?php echo e($siteName->name ?? 'Gadget Style'); ?></title>
    ...
    <main class="flex-1 overflow-y-auto h-screen w-full">
        ...
        <header class="bg-white px-6 lg:px-8 py-4 flex justify-between items-center sticky top-0 z-20 shadow-sm border-b">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-gray-400 mt-0.5 hidden sm:block">রিফান্ড আইডি: #<?php echo e($refund->refund_id); ?></p>
            </div>
        ...
        <div class="p-4 lg:p-8 max-w-7xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">রিফান্ড আইডি: #<?php echo e($refund->refund_id); ?></p>
                </div>
                <div class="flex gap-2">
                    <a href="<?php echo e(route('customer.refunds')); ?>" class="inline-flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-semibold transition">
            ...
            <?php if($refund->status != 'rejected'): ?>
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                    <div class="flex items-center justify-between relative">
                        ...
                        <div class="flex flex-col items-center relative z-10">
                            <div class="w-12 h-12 rounded-full <?php echo e(in_array($refund->status, ['approved', 'processed']) ? 'bg-indigo-600' : 'bg-gray-300'); ?> text-white flex items-center justify-center font-bold shadow-lg">
                                <i class="fas fa-check"></i>
                            </div>
                            <span class="text-xs font-semibold <?php echo e(in_array($refund->status, ['approved', 'processed']) ? 'text-indigo-600' : 'text-gray-400'); ?> mt-2">Approved</span>
                        </div>
                        
                        <div class="flex flex-col items-center relative z-10">
                            <div class="w-12 h-12 rounded-full <?php echo e($refund->status == 'processed' ? 'bg-indigo-600' : 'bg-gray-300'); ?> text-white flex items-center justify-center font-bold shadow-lg">
                                <i class="fas fa-check"></i>
                            </div>
                            <span class="text-xs font-semibold <?php echo e($refund->status == 'processed' ? 'text-indigo-600' : 'text-gray-400'); ?> mt-2">Processed</span>
                        </div>
                    </div>
                </div>
            <?php else: ?>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-lg p-6 text-white mb-6">
                        <div class="text-center">
                            ...
                            <h2 class="text-4xl font-bold mb-2">৳<?php echo e(number_format($refund->amount + $refund->shipping_charge, 2)); ?></h2>
                            <p class="text-xs opacity-80">
                                (পণ্য: ৳<?php echo e(number_format($refund->amount, 2)); ?> + ডেলিভারি: ৳<?php echo e(number_format($refund->shipping_charge, 2)); ?>)
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <span class="inline-block bg-indigo-50 text-indigo-600 px-3 py-1 rounded-full text-sm font-semibold">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $refund->refund_method ?? 'Unknown'))); ?>

                                </span>
                            </div>
                            <?php if($refund->refund_account): ?>
                            <div>
                                <p class="text-xs text-gray-500 uppercase mb-1">অ্যাকাউন্ট নম্বর</p>
                                <p class="font-semibold text-gray-800"><?php echo e($refund->refund_account); ?></p>
                                <?php if($refund->refund_account_name): ?>
                                    <p class="text-sm text-gray-500"><?php echo e($refund->refund_account_name); ?></p>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                            ...
                            <div>
                                ...
                                <code class="block bg-gray-50 text-indigo-600 px-3 py-2 rounded-lg text-sm font-mono"><?php echo e($refund->transaction_id); ?></code>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                            ...
                            <a href="<?php echo e(route('customer.invoice', ['id' => $refund->order->id])); ?>" class="text-indigo-600 hover:text-indigo-700 text-sm font-semibold flex items-center gap-1">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div>
                                    ...
                                    <p class="font-bold text-gray-800">#<?php echo e($refund->order->invoice_id ?? $refund->order->id); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase mb-1">অর্ডার তারিখ</p>
                                    <p class="font-semibold text-gray-800"><?php echo e($refund->order->created_at->format('d M, Y')); ?></p>
                                </div>
                                <div>
                                    ...
                                    <span class="inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-semibold">
                                        <?php echo e($refund->order->status ? $refund->order->status->name : 'N/A'); ?>

                                    </span>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase mb-1">মোট অর্ডার</p>
                                    <p class="font-bold text-gray-800">৳<?php echo e(number_format($refund->order->amount + $refund->order->shipping_charge, 2)); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="border-t border-gray-100 pt-6">
                                ...
                                <div class="bg-gray-50 border-l-4 border-indigo-500 p-4 rounded-r-lg">
                                    <p class="text-gray-700 italic">"<?php echo e($refund->reason ?? 'কোনো কারণ দেওয়া হয়নি'); ?>"</p>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg">
                                ...
                                <p class="text-gray-700 text-sm"><?php echo e($refund->admin_note); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\refund_details.blade.php ENDPATH**/ ?>