...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Financial overview for: <strong><?php echo e($label ?? 'Today'); ?></strong></p>
        </div>
    </div>

    
    <div class="filter-card">
        <form method="GET" action="<?php echo e(route('admin.reports.profit_loss')); ?>" id="profitLossFilterForm">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2 type-month type-year" style="display:none;">
                    ...
                    <input type="number" name="year" class="form-control form-control-custom" value="<?php echo e(request('year', now()->year)); ?>">
                </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-3">
                <div class="stat-card bg-soft-primary">
                    ...
                    <div class="stat-amount">৳<?php echo e(number_format($salesAmount ?? 0, 2)); ?></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card bg-soft-warning">
                    <div class="stat-title">COGS (Cost)</div>
                    <div class="stat-amount">৳<?php echo e(number_format($cogs ?? 0, 2)); ?></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card bg-soft-secondary">
                    <div class="stat-title">Total Expenses</div>
                    <div class="stat-amount">৳<?php echo e(number_format($totalExpense ?? 0, 2)); ?></div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card <?php echo e(($netProfit ?? 0) >= 0 ? 'bg-soft-success' : 'bg-soft-danger'); ?>">
                    <div class="stat-title">Net Profit/Loss</div>
                    <div class="stat-amount">৳<?php echo e(number_format($netProfit ?? 0, 2)); ?></div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-bordered mb-0 summary-table">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end text-primary">৳<?php echo e(number_format($salesAmount ?? 0, 2)); ?></td>
                            </tr>
                            <tr>
                                <th>Cost of Goods Sold (COGS)</th>
                                <td class="text-end text-danger">- ৳<?php echo e(number_format($cogs ?? 0, 2)); ?></td>
                            </tr>
                            <tr class="bg-light">
                                <th><strong>Gross Profit</strong></th>
                                <td class="text-end fw-bold">৳<?php echo e(number_format($grossProfit ?? 0, 2)); ?></td>
                            </tr>
                            <tr>
                                <th>Operating Expenses</th>
                                <td class="text-end text-danger">- ৳<?php echo e(number_format($totalExpense ?? 0, 2)); ?></td>
                            </tr>
                            <tr class="<?php echo e(($netProfit ?? 0) >= 0 ? 'net-profit-row' : 'net-loss-row'); ?>">
                                <th class="fs-5"><strong>Net Profit / (Loss)</strong></th>
                                <td class="text-end fs-4 fw-bold <?php echo e(($netProfit ?? 0) >= 0 ? 'text-success' : 'text-danger'); ?>">
                                    ৳<?php echo e(number_format($netProfit ?? 0, 2)); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\reports\profit_loss.blade.php ENDPATH**/ ?>