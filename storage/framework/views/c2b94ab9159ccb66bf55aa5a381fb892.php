                                ...
                                <div class="sidebar-content">
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex align-items-center gap-3 mb-2">
                                            <i data-feather="phone-call"></i> <span><?php echo e($contact->hotline); ?></span>
                                        </div>
                                        <div class="d-flex align-items-center gap-3">
                                            <i data-feather="mail"></i> <span><?php echo e($contact->email); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-side">
                                ...
                                <?php if(session('success')): ?>
                                    <div class="alert alert-success border-0 shadow-sm mb-4">
                                        <i class="me-2" data-feather="check-circle"></i> <?php echo e(session('success')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\bilaiGhor\resources\views/frontEnd/layouts/pages/complaint.blade.php ENDPATH**/ ?>