...
<?php $__env->startSection('title', 'অ্যাকাউন্ট ভেরিফিকেশন'); ?>
        ...
        <div class="alert alert-danger mb-4 rounded-3 border-0 bg-danger bg-opacity-10 text-danger">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0 small"><?php echo e($user->verification_note ?? 'অনুগ্রহ করে ডকুমেন্ট পুনরায় আপলোড করুন।'); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>

    <form action="<?php echo e(route('reseller.verification.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="step-card p-4">
                    ...
                    <div class="upload-zone-wrapper">
                        ...
                        <?php $hasFront = !empty($user->voter_id_front); ?>

                        <label for="voter_id_front" class="custom-upload-box w-100" id="box_front" style="<?php echo e($hasFront ? 'display:none;' : 'display:flex;'); ?>">
                        ...
                        <div class="preview-container" id="preview_front_container" style="<?php echo e($hasFront ? 'display:block;' : 'display:none;'); ?>">
                            <img src="<?php echo e($hasFront ? asset($user->voter_id_front) : ''); ?>" class="preview-img" id="preview_front_img">
                            <div class="preview-overlay">
                                <span class="badge bg-success bg-opacity-75 backdrop-blur">
                                    <?php echo e($hasFront ? 'সংরক্ষিত আছে' : 'নতুন ছবি'); ?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="step-card p-4">
                    ...
                    <div class="upload-zone-wrapper">
                        ...
                        <?php $hasBack = !empty($user->voter_id_back); ?>

                        <label for="voter_id_back" class="custom-upload-box w-100" id="box_back" style="<?php echo e($hasBack ? 'display:none;' : 'display:flex;'); ?>">
                            <div class="upload-icon-circle">
                        ...
                        <div class="preview-container" id="preview_back_container" style="<?php echo e($hasBack ? 'display:block;' : 'display:none;'); ?>">
                            <img src="<?php echo e($hasBack ? asset($user->voter_id_back) : ''); ?>" class="preview-img" id="preview_back_img">
                            <div class="preview-overlay">
                                <span class="badge bg-success bg-opacity-75 backdrop-blur">
                                    <?php echo e($hasBack ? 'সংরক্ষিত আছে' : 'নতুন ছবি'); ?>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="step-card p-4">
                    ...
                    <div class="upload-zone-wrapper">
                        ...
                        <?php $hasSelf = !empty($user->self_image); ?>

                        <label for="self_image" class="custom-upload-box w-100" id="box_self" style="<?php echo e($hasSelf ? 'display:none;' : 'display:flex;'); ?>">
                            <div class="upload-icon-circle">
                        ...
                        <div class="preview-container" id="preview_self_container" style="<?php echo e($hasSelf ? 'display:block;' : 'display:none;'); ?>">
                            <img src="<?php echo e($hasSelf ? asset($user->self_image) : ''); ?>" class="preview-img" id="preview_self_img">
                            <div class="preview-overlay">
                                <span class="badge bg-success bg-opacity-75 backdrop-blur">
                                    <?php echo e($hasSelf ? 'সংরক্ষিত আছে' : 'নতুন ছবি'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\verification\index.blade.php ENDPATH**/ ?>