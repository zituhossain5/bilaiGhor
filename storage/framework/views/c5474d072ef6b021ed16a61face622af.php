...
<?php $__env->startSection('title', 'Fund Transaction Logs / Reports'); ?>
...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.fund.logs')); ?>" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('admin.fund.logs')); ?>" class="btn btn-outline-secondary">Clear</a>
                </div>
            </form>
        </div>
    </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <?php if($log->fundTransaction): ?>
                                    #<?php echo e($log->fund_transaction_id); ?>

                                <?php else: ?>
                                    <span class="text-muted">#<?php echo e($log->fund_transaction_id); ?> (Deleted)</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($log->old_direction): ?>
                                    <div><strong>Dir:</strong> <?php echo e(strtoupper($log->old_direction)); ?></div>
                            ...
                            <td>
                                <?php if($log->new_direction): ?>
                                    <div><strong>Dir:</strong> <?php echo e(strtoupper($log->new_direction)); ?></div>
                            ...
                            <td>
                                <div><strong>Before:</strong> <?php echo e(number_format($log->balance_before, 2)); ?> ৳</div>
                                <div><strong>After:</strong> <?php echo e(number_format($log->balance_after, 2)); ?> ৳</div>
                                <?php
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\fund\logs.blade.php ENDPATH**/ ?>