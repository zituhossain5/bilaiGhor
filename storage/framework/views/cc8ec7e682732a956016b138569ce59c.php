...
<?php $__env->startSection('title',$childcategory->childcategoryName); ?> 
<?php $__env->startPush('css'); ?>
<link rel="stylesheet" href="<?php echo e(asset('public/frontEnd/css/jquery-ui.css')); ?>" />
<?php $__env->stopPush(); ?> 
<?php $__env->startPush('seo'); ?>
<meta name="app-url" content="<?php echo e(route('products',$childcategory->slug)); ?>" />
<meta name="robots" content="index, follow" />
<meta name="description" content="<?php echo e($childcategory->meta_description); ?>" />
<meta name="keywords" content="<?php echo e($childcategory->slug); ?>" />

<!-- Twitter Card data -->
<meta name="twitter:card" content="product" />
<meta name="twitter:site" content="<?php echo e($childcategory->childcategoryName); ?>" />
<meta name="twitter:title" content="<?php echo e($childcategory->childcategoryName); ?>" />
<meta name="twitter:description" content="<?php echo e($childcategory->meta_description); ?>" />
<meta name="twitter:creator" content="gomobd.com" />
<meta property="og:url" content="<?php echo e(route('products',$childcategory->slug)); ?>" />
<meta name="twitter:image" content="<?php echo e(asset($childcategory->image)); ?>" />

<!-- Open Graph data -->
<meta property="og:title" content="<?php echo e($childcategory->childcategoryName); ?>" />
<meta property="og:type" content="product" />
<meta property="og:url" content="<?php echo e(route('products',$childcategory->slug)); ?>" />
<meta property="og:image" content="<?php echo e(asset($childcategory->image)); ?>" />
<meta property="og:description" content="<?php echo e($childcategory->meta_description); ?>" />
<meta property="og:site_name" content="<?php echo e($childcategory->childcategoryName); ?>" />
<?php $__env->stopPush(); ?> 
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="category-breadcrumb d-flex align-items-center">
                        ...
                        <span>/</span>
                        <strong><?php echo e($childcategory->childcategoryName); ?></strong>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
...
<section class="homeproduct">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="meta_des">
                    <?php echo $childcategory->meta_description; ?>
...
<?php $__env->startPush('script'); ?>
    ...
    <script type="text/javascript">
        ...
        (function () {
            var listName = <?php echo json_encode($childcategory->childcategoryName, 15, 512) ?>;
            var listSlug = <?php echo json_encode($childcategory->slug, 15, 512) ?>;
            ...
            var listItems = [
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                {
                    ...
                    item_category: <?php echo json_encode(optional($value->category)->name ?? $childcategory->childcategoryName, 15, 512) ?>,
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\pages\childcategory.blade.php ENDPATH**/ ?>