...
<?php $__env->startSection('title','Manage Sizes'); ?>
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('sizes.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                    ...
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="size-badge"><?php echo e($value->sizeName); ?></span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('sizes.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\size\index.blade.php ENDPATH**/ ?>