...
<?php $__env->startSection('title', 'প্রোডাক্ট ক্যাটালগ'); ?>
<?php $__env->startSection('page-title', 'প্রোডাক্ট ক্যাটালগ'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="filter-card">
        <form action="<?php echo e(route('reseller.products.index')); ?>" method="GET">
            <div class="row g-3 align-items-end">
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="keyword" class="form-control border-start-0 ps-0" placeholder="প্রোডাক্ট নাম বা কোড..." value="<?php echo e(request('keyword')); ?>">
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-4">
                    ...
                    <select name="sort" class="form-select">
                        <option value="latest" <?php echo e(request('sort') == 'latest' ? 'selected' : ''); ?>>নতুন সংযোজন</option>
                        <option value="price_low" <?php echo e(request('sort') == 'price_low' ? 'selected' : ''); ?>>দাম: কম থেকে বেশি</option>
                        <option value="price_high" <?php echo e(request('sort') == 'price_high' ? 'selected' : ''); ?>>দাম: বেশি থেকে কম</option>
                        <option value="profit_high" <?php echo e(request('sort') == 'profit_high' ? 'selected' : ''); ?>>সর্বোচ্চ লাভ</option>
                    </select>
                </div>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 px-2">
        <div>
            ...
            <small class="text-muted"><i class="fas fa-box-open me-1"></i> <?php echo e($products->total()); ?> টি পণ্য পাওয়া গেছে</small>
        </div>
        <?php if(request()->hasAny(['keyword', 'category_id', 'brand_id', 'sort'])): ?>
            <a href="<?php echo e(route('reseller.products.index')); ?>" class="btn btn-sm btn-light border rounded-pill px-3 shadow-sm text-danger mt-2 mt-md-0">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="product-card h-100">
                <div class="img-wrapper">
                    <?php if($product->created_at->isToday()): ?>
                        <span class="product-badge"><i class="fas fa-bolt me-1"></i> New</span>
                    <?php elseif($product->topsale): ?>
                        <span class="product-badge hot"><i class="fas fa-fire me-1"></i> Hot</span>
                    <?php endif; ?>

                    <a href="<?php echo e(route('reseller.products.show', $product->slug)); ?>">
                        <?php if($product->image && $product->image->image): ?>
                            <img src="<?php echo e(asset($product->image->image)); ?>" class="product-img" alt="<?php echo e($product->name); ?>">
                        <?php else: ?>
                ...
                <div class="p-4 flex-grow-1 d-flex flex-column">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span class="badge <?php echo e($product->stock > 10 ? 'bg-success' : 'bg-danger'); ?> bg-opacity-10 <?php echo e($product->stock > 10 ? 'text-success' : 'text-danger'); ?> rounded-pill px-2">
                            স্টক: <?php echo e($product->stock > 50 ? '৫০+' : $product->stock); ?>

                        </span>
                    </div>

                    <h6 class="fw-bold text-dark mb-2">
                        <a href="<?php echo e(route('reseller.products.show', $product->slug)); ?>" class="text-decoration-none text-dark stretched-link">
                    ...
                    <div class="mb-3">
                        <span class="profit-chip">
                            <i class="fas fa-coins text-success"></i> লাভ: ৳<?php echo e(number_format($product->profit, 0)); ?>
                    ...
                    <div class="mt-auto pt-3 border-top border-light">
                        <div class="d-flex justify-content-between align-items-end mb-3">
                            <div>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <span class="fw-bold fs-5 text-primary">৳ <?php echo e(number_format($product->reseller_price, 0)); ?></span>
                                    <?php if($product->old_price > $product->reseller_price): ?>
                                        <small class="text-muted text-decoration-line-through">৳<?php echo e(number_format($product->old_price, 0)); ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-2 position-relative" style="z-index: 2;">
                            <button type="button" class="btn-action-circle" onclick="copyProductLink('<?php echo e(route('product', $product->slug)); ?>')" title="লিংক কপি করুন">
                                <i class="fas fa-link"></i>
                            </button>
                            
                            <a href="<?php echo e(route('reseller.products.show', $product->slug)); ?>" class="btn-action-circle" title="বিস্তারিত দেখুন">
                                <i class="fas fa-eye"></i>
                            </a>

                            
                            <a href="<?php echo e(route('reseller.products.show', $product->slug)); ?>" class="btn btn-primary btn-sm rounded-pill w-100 d-flex align-items-center justify-content-center fw-bold shadow-sm" style="background: var(--primary-gradient); border:none; text-decoration: none;">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-4 py-5 text-center">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('reseller.products.index')); ?>" class="btn btn-primary rounded-pill px-4 mt-2">
...
<div class="d-flex justify-content-center mt-5">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination custom-pagination mb-0">
            ...
            <?php else: ?>
                <li class="page-item"><a class="page-link" href="<?php echo e($products->previousPageUrl()); ?>">&laquo; Prev</a></li>
            <?php endif; ?>
            ...
            <?php if($products->hasMorePages()): ?>
                <li class="page-item"><a class="page-link" href="<?php echo e($products->nextPageUrl()); ?>">Next &raquo;</a></li>
            <?php else: ?>
...
<script>
    ...
    function addToCartReseller(event, productId) {
        ...
        fetch('<?php echo e(route("reseller.cart.add.ajax")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\products\catalog.blade.php ENDPATH**/ ?>