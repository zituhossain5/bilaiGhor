...
<?php $__currentLoopData = $orders->chunk(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="a4-page">
    ...
    <div class="label">
        <?php if($isCOD): ?><div class="cod-ribbon">COD</div><?php endif; ?>

        
        <div class="lbl-top">
            <div>
                <div class="from-tag">From</div>
                <div class="from-name"><?php echo e($generalsetting->name); ?></div>
                <div class="from-cont">
                    <?php echo e($contact->phone ?? ''); ?>

                    <?php if($contact->address): ?> &middot; <?php echo e(Str::limit($contact->address,35)); ?><?php endif; ?>
                </div>
            </div>
            <div class="inv-block">
                <div class="inv-tag">Invoice</div>
                <div class="inv-num">#<?php echo e($order->invoice_id); ?></div>
                <div class="inv-date"><?php echo e($order->created_at->format('d M Y')); ?></div>
            </div>
        </div>
        ...
        <div class="lbl-to">
            ...
            <?php if($order->shipping): ?>
                <div class="to-name"><?php echo e($order->shipping->name ?? '—'); ?></div>
                <div class="to-phone">&#128222; <?php echo e($order->shipping->phone ?? ''); ?></div>
                <div class="to-addr">
                    <?php echo e($order->shipping->address ?? ''); ?>

                    <?php if($order->shipping->area): ?>, <?php echo e($order->shipping->area); ?><?php endif; ?>
                </div>
            <?php else: ?>
        ...
        <div class="lbl-prods">
            ...
            <div class="prod-row">
                <?php if($imgPath): ?>
                    <img class="prod-img" src="<?php echo e(asset($imgPath)); ?>" alt=""
                ...
                <?php endif; ?>
                <div class="prod-info">
                    <div class="prod-name"><?php echo e(Str::limit($item->product_name, 38)); ?></div>
                    <div class="prod-meta">
                        <?php if($sz): ?><span class="badge-sz">Sz: <?php echo e($sz); ?></span><?php endif; ?>
                        <?php if($cl): ?><span class="badge-cl"><?php echo e($cl); ?></span><?php endif; ?>
                        <span class="badge-qty">&times; <?php echo e($item->qty); ?></span>
                    </div>
                </div>
            </div>
        ...
        <div class="lbl-bottom">
            <div class="lbl-courier">
                ...
                <div class="c-name <?php echo e($cClass); ?>">
                    <?php if($courier === 'steadfast'): ?> &#128309; Steadfast
                    <?php elseif($courier === 'pathao'): ?> &#128311; Pathao
                    <?php elseif($courier === 'redx'): ?> &#128992; RedX
                    <?php elseif($courier): ?> <?php echo e(ucfirst($courier)); ?>

                    <?php else: ?> <span style="color:#bbb;">— Not Assigned —</span>
                    <?php endif; ?>
                </div>
                <?php if($trkId): ?><div class="c-id">ID: <?php echo e($trkId); ?></div><?php endif; ?>
                <?php if($order->courier_sent_at): ?>
                    <div class="c-id" style="color:#888;">Sent: <?php echo e(\Carbon\Carbon::parse($order->courier_sent_at)->format('d M Y')); ?></div>
                <?php endif; ?>
            </div>
            <div class="lbl-amount">
                <div class="a-tag">Total</div>
                <div class="a-val">&#2547;<?php echo e(number_format($order->amount,0)); ?></div>
                <div class="a-qty"><?php echo e($totalQty); ?> <?php echo e($totalQty>1?'pcs':'pc'); ?></div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\order\label.blade.php ENDPATH**/ ?>