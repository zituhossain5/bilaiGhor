...
<div class="container-fluid mb-5">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-2">
        ...
        <a href="<?php echo e(route('purchases.logs')); ?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100 py-2 border-start border-4 border-success">
                <div class="card-body stats-card">
                    ...
                    <div>
                        <div class="stats-label text-success">This Year (<?php echo e($currentYear); ?>)</div>
                        <div class="stats-value"><?php echo e(number_format($yearlyTotal, 2)); ?> ৳</div>
            ...
            <div class="card h-100 py-2 border-start border-4 border-info">
                <div class="card-body stats-card">
                    ...
                    <div>
                        ...
                        <div class="stats-value"><?php echo e(number_format($monthlyTotal, 2)); ?> ৳</div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100 py-2 border-start border-4 border-primary">
                <div class="card-body stats-card">
                    ...
                    <div>
                        <div class="stats-label text-primary">Today (<?php echo e(now()->format('d M')); ?>)</div>
                        <div class="stats-value"><?php echo e(number_format($todayTotal, 2)); ?> ৳</div>
            ...
            <div class="card h-100 py-2 border-start border-4 border-danger">
                <div class="card-body stats-card">
                    ...
                    <div>
                        ...
                        <div class="stats-value"><?php echo e(number_format($totalDue, 2)); ?> ৳</div>
                    ...
                    <form action="<?php echo e(route('purchases.store')); ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="invoice_no" class="form-control" value="<?php echo e('PUR-'.time()); ?>" required readonly style="background-color: #f8f9fc;">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Date *</label>
                                <input type="date" name="purchase_date" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>" required>
                            </div>
                        </div>
                    ...
                    <form action="<?php echo e(route('purchases.export')); ?>" method="GET" target="_blank">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="month" class="form-control" placeholder="Month (1-12)" value="<?php echo e(request('month')); ?>">
            ...
            <div id="purchase-table-wrapper" class="table-responsive">
                <table class="table table-bordered table-hover mb-0" width="100%" cellspacing="0">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr>
                            <td class="text-center"><?php echo e($loop->iteration + ($purchases->currentPage()-1)*$purchases->perPage()); ?></td>
                            <td>
                                <?php echo e(\Carbon\Carbon::parse($p->purchase_date)->format('d M, Y')); ?>

                            </td>
                            <td>
                                <span class="fw-bold text-dark"><?php echo e($p->invoice_no); ?></span>
                                <?php if($p->updated_by): ?>
                            ...
                            <td>
                                <?php if($p->supplier): ?>
                                    <div class="fw-bold text-secondary"><?php echo e($p->supplier->name); ?></div>
                                    <small class="text-muted"><?php echo e($p->supplier->phone); ?></small>
                                <?php else: ?>
                                    <span class="text-danger">Deleted</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-end fw-bold"><?php echo e(number_format($p->grand_total,2)); ?></td>
                            <td class="text-end text-success"><?php echo e(number_format($p->paid_amount,2)); ?></td>
                            <td class="text-end text-danger"><?php echo e(number_format($p->due_amount,2)); ?></td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center align-items-center gap-1">
                                    <a href="<?php echo e(route('purchases.invoice',$p->id)); ?>" class="btn btn-action btn-outline-secondary" target="_blank" title="Invoice">
                                        <i class="fe-file-text"></i>
                                    </a>

                                    <?php if($p->due_amount > 0): ?>
                                        <form action="<?php echo e(route('purchases.pay_due',$p->id)); ?>" method="POST" class="d-flex align-items-center bg-light rounded p-1 border">
                                            <?php echo csrf_field(); ?>
                                            <input type="number" step="0.01" name="amount" class="pay-input me-1" placeholder="Pay Due" required>
                                            <input type="hidden" name="payment_date" value="<?php echo e(now()->format('Y-m-d')); ?>">
                                    ...
                                    <?php if($isAdmin): ?>
                                        <a href="<?php echo e(route('purchases.edit', $p->id)); ?>" class="btn btn-action btn-outline-primary ms-1" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>
                                        <form method="POST" action="<?php echo e(route('purchases.destroy', $p->id)); ?>" class="d-inline delete-form">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\purchases\index.blade.php ENDPATH**/ ?>