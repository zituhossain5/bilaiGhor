...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('reviews.update')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control select2" name="product_id" required>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value->id); ?>" <?php echo e($edit_data->product_id==$value->id?'selected':''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="email" class="form-control" name="email" value="<?php echo e($edit_data->email); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea name="review" class="form-control" rows="5" required><?php echo e($edit_data->review); ?></textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control select2" name="ratting" required>
                                ...
                                <option value="5" <?php echo e($edit_data->ratting == 5 ? 'selected' : ''); ?>>⭐⭐⭐⭐⭐ (5 Stars)</option>
                                <option value="4" <?php echo e($edit_data->ratting == 4 ? 'selected' : ''); ?>>⭐⭐⭐⭐ (4 Stars)</option>
                                <option value="3" <?php echo e($edit_data->ratting == 3 ? 'selected' : ''); ?>>⭐⭐⭐ (3 Stars)</option>
                                <option value="2" <?php echo e($edit_data->ratting == 2 ? 'selected' : ''); ?>>⭐⭐ (2 Stars)</option>
                                <option value="1" <?php echo e($edit_data->ratting == 1 ? 'selected' : ''); ?>>⭐ (1 Star)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded border border-light">
                            ...
                            <label class="switch">
                                ...
                                <input type="checkbox" name="status" value="active" <?php if($edit_data->status=='active'): ?> checked <?php endif; ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\review\edit.blade.php ENDPATH**/ ?>