...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('colors.store')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="colorName" value="<?php echo e(old('colorName')); ?>" id="colorName" 
...
unset($__errorArgs, $__bag); ?>" 
                                               name="color" value="<?php echo e(old('color')); ?>" id="color" required 
                                               onchange="updateColorCode(this.value)">
                                        <span id="colorCode" class="color-code"><?php echo e(old('color') ?? '#000000'); ?></span>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\color\create.blade.php ENDPATH**/ ?>