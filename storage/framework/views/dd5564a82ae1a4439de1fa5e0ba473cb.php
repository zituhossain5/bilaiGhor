...
// Balance comes from the controller (reward ledger); fall back defensively.
...
.bilai-rw-hist-tab:hover { border-color: var(--bilai-rw-primary); color: var(--bilai-rw-primary); text-decoration: none; }
.bilai-rw-hist-tab.active { border-color: var(--bilai-rw-primary); color: var(--bilai-rw-primary); background: #fff3dd; }
a.bilai-rw-hist-tab { text-decoration: none; display: inline-block; }

/* Transaction history list */
.bilai-rw-hist-list { display: flex; flex-direction: column; }
.bilai-rw-hist-item { display: flex; align-items: center; gap: 14px; padding: 13px 4px; border-bottom: 1px solid var(--bilai-rw-border); }
.bilai-rw-hist-item:last-child { border-bottom: none; }
.bilai-rw-hist-item-ic {
    width: 36px; height: 36px; border-radius: 50%; flex-shrink: 0;
    display: flex; align-items: center; justify-content: center; font-size: 13px;
}
.bilai-rw-hist-item-ic.credit { background: #e8f5e9; color: #2e7d32; }
.bilai-rw-hist-item-ic.debit  { background: #fdecea; color: #c0392b; }
.bilai-rw-hist-item-info { flex: 1; min-width: 0; }
.bilai-rw-hist-item-desc { font-size: 13px; font-weight: 600; color: var(--bilai-rw-text); margin: 0 0 3px; }
.bilai-rw-hist-item-date { font-size: 11.5px; color: var(--bilai-rw-muted); margin: 0; }
.bilai-rw-hist-item-amt { text-align: right; flex-shrink: 0; }
.bilai-rw-hist-item-pts { font-size: 14px; font-weight: 700; margin: 0 0 2px; }
.bilai-rw-hist-item-pts.credit { color: #2e7d32; }
.bilai-rw-hist-item-pts.debit  { color: #c0392b; }
.bilai-rw-hist-item-bal { font-size: 11px; color: var(--bilai-rw-muted); margin: 0; }
.bilai-rw-hist-pagination { display: flex; justify-content: center; padding-top: 14px; }
.bilai-rw-hist-pagination .pagination { margin: 0; }
...
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\frontEnd\layouts\customer\rewards.blade.php ENDPATH**/ ?>