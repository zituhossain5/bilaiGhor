...
<?php $__env->startSection('title', 'Manual Duplicate Order Check'); ?>
...
<div class="container-fluid py-4">
    <div class="card shadow-sm p-4">
        ...
        <form action="<?php echo e(route('manualDuplicateOrder.check')); ?>" method="POST" class="text-center mb-4">
            <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow-sm p-4">
                    ...
                    <div class="success-circle" style="border-color: <?php echo e($isDuplicate ? '#dc3545' : '#28a745'); ?>">
                        <div class="text-center">
                            <span class="fw-bold fs-2" style="color: <?php echo e($isDuplicate ? '#dc3545' : '#28a745'); ?>">
                                <?php echo e($duplicateCount); ?>
                    ...
                    <?php if($isDuplicate): ?>
                        <div class="status-box status-red">
                            ...
                            <p class="mb-0">এই মোবাইল নাম্বার দিয়ে <?php echo e($duplicateCount); ?> টি ডুপ্লিকেট অর্ডার পাওয়া গেছে।</p>
                            <?php if($lastDuplicateDate): ?>
                                <p class="mb-0 mt-2"><small>সর্বশেষ ডুপ্লিকেট অর্ডার: <?php echo e($lastDuplicateDate); ?></small></p>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                    ...
                    <div class="mt-4">
                        ...
                        <pre class="bg-light p-3 rounded"><?php echo e(json_encode($data['details'], JSON_PRETTY_PRINT)); ?></pre>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\duplicate_order\manual_check.blade.php ENDPATH**/ ?>