...
<?php $__env->startSection('title', 'Edit Popup Campaign'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.popup.index')); ?>" class="btn btn-light border text-muted fw-bold">
    ...
    <form action="<?php echo e(route('admin.popup.update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="hidden_id" value="<?php echo e($edit->id); ?>">
                ...
                <div class="card edit-card h-100">
                    ...
                    <div class="card-body p-4 text-center">
                        <div class="image-upload-container" onclick="document.getElementById('editImageInput').click()">
                            <img id="editImgPreview" src="<?php echo e(url('public/'.$edit->image)); ?>" class="current-img-preview" alt="Popup Image">
                        ...
                        <div class="mt-4 text-start">
                            ...
                            <input type="text" class="form-control" name="link" value="<?php echo e($edit->link); ?>" placeholder="https://...">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" value="1" id="statusSwitch" <?php echo e($edit->status == 1 ? 'checked' : ''); ?> style="width: 3em; height: 1.5em; cursor: pointer;">
                            </div>
                        </div>
                ...
                <div class="card edit-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" value="<?php echo e($edit->title); ?>" placeholder="Admin list এর জন্য">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small">বর্ণনা</label>
                            <textarea class="form-control" name="description" rows="2"><?php echo e($edit->description); ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col-6 mb-3">
                                <label class="form-label small">বাটন টেক্সট</label>
                                <input type="text" class="form-control" name="btn_text" value="<?php echo e($edit->btn_text); ?>">
                            </div>
                            <div class="col-6 mb-3">
                                <label class="form-label small">ফুটার টেক্সট</label>
                                <input type="text" class="form-control" name="offer_end_text" value="<?php echo e($edit->offer_end_text); ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\popup\edit.blade.php ENDPATH**/ ?>