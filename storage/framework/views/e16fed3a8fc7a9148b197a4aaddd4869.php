    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <div class="studio-card p-4">
                <form action="<?php echo e(route('banner_category.store')); ?>" method="POST" id="categoryForm" data-parsley-validate="">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\banner\category\create.blade.php ENDPATH**/ ?>