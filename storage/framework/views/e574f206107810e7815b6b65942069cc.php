...
<?php $__env->startSection('title', 'Facebook Ads Result'); ?>
...
<div class="container-fluid py-3">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
      ...
      <a href="<?php echo e(route('admin.ads_analytics.facebook', ['refresh' => 1])); ?>" class="btn btn-sm btn-primary">
    ...
    <?php if(($facebook['success'] ?? false)): ?>
      ...
      <div class="metric-row">
        <div class="metric-item">
          <div class="metric-value">$<?php echo e(number_format($facebook['spend'] ?? 0, 2)); ?></div>
          <div class="metric-label">Spend</div>
        </div>
        <div class="metric-item">
          <div class="metric-value"><?php echo e(number_format($facebook['clicks'] ?? 0)); ?></div>
          <div class="metric-label">Clicks</div>
        </div>
        <div class="metric-item">
          <div class="metric-value"><?php echo e(number_format($facebook['impressions'] ?? 0)); ?></div>
          <div class="metric-label">Impressions</div>
        </div>
        <div class="metric-item">
          <div class="metric-value"><?php echo e(number_format($facebook['reach'] ?? 0)); ?></div>
          <div class="metric-label">Reach</div>
        </div>
        <div class="metric-item">
          <div class="metric-value"><?php echo e(number_format($facebook['conversions'] ?? 0)); ?></div>
          <div class="metric-label">Conversions</div>
        </div>
      </div>
    <?php else: ?>
      <p class="text-muted mb-3"><?php echo e($facebook['message'] ?? 'Configure Facebook API in Settings'); ?></p>
      <a href="<?php echo e(route('admin.ads_analytics.settings')); ?>" class="btn btn-primary">Configure API</a>
    <?php endif; ?>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views/backEnd/ads_analytics/facebook.blade.php ENDPATH**/ ?>