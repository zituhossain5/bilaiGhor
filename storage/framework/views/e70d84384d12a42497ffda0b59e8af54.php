...
<?php $__env->startSection('title', 'চেকআউট'); ?>
<?php $__env->startSection('page-title', 'চেকআউট'); ?>
...
<section class="checkout-section">
    ...
    <div class="container" style="max-width: 1200px;">
        <form id="checkout-form" action="<?php echo e(route('reseller.checkout.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="checkout_otp" id="reseller_checkout_otp_hidden" value="<?php echo e(old('checkout_otp')); ?>">
            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control-custom" 
                                            value="<?php echo e(old('name')); ?>" placeholder="সম্পূর্ণ নাম" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" class="form-control-custom" minlength="11" maxlength="11" pattern="0[0-9]+" 
                                            value="<?php echo e(old('phone')); ?>" placeholder="017xxxxxxxx" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control-custom" 
                                            value="<?php echo e(old('address')); ?>" placeholder="বাসা নং, রোড নং, এলাকা, জেলা" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="order_note" class="form-control-custom" rows="2" style="height:auto; resize:none;" 
                                            placeholder="ডেলিভারি সম্পর্কে বিশেষ কিছু বলার থাকলে লিখুন..."><?php echo e(old('order_note')); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="checkout-card">
                        ...
                        <div class="card-body-custom">
                                ...
                                <div class="alert alert-warning border-0 shadow-sm mb-4" style="border-left: 5px solid #ffc107 !important; background-color: #fff8e1;">
                                    <div class="d-flex gap-3 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 small">এই অর্ডারে <b>৳ <?php echo e(number_format($advanceAmount, 2)); ?></b> অগ্রিম পেমেন্ট করতে হবে।</p>
                                            <p class="mb-0 small mt-1">অবশিষ্ট <b>৳ <?php echo e(number_format($dueAmount, 2)); ?></b> ডেলিভারির সময় পরিশোধ করতে হবে।</p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="payment-options-list">
                                ...
                                <?php elseif(!$hasDigital && $hasAdvance): ?>
                                ...
                                <?php if($bkash_gateway): ?>
                                    <label class="payment-option-label">
                                        <input type="radio" name="payment_method" value="bkash" <?php echo e($hasAdvance ? 'checked' : ''); ?> required> 
                                        <div class="payment-content">
                                ...
                                <?php if($shurjopay_gateway): ?>
                                    <label class="payment-option-label">
                                        <input type="radio" name="payment_method" value="shurjopay" <?php echo e($hasAdvance && !$bkash_gateway ? 'checked' : ''); ?> required>
                                        <div class="payment-content">
                                ...
                                <?php if($uddoktapay_gateway): ?>
                                    <label class="payment-option-label">
                                        <input type="radio" name="payment_method" value="uddoktapay" <?php echo e($hasAdvance && !$bkash_gateway && !$shurjopay_gateway ? 'checked' : ''); ?> required>
                                        <div class="payment-content">
                                ...
                                <?php if($aamarpay_gateway): ?>
                                    <label class="payment-option-label">
                                        <input type="radio" name="payment_method" value="aamarpay" <?php echo e($hasAdvance && !$bkash_gateway && !$shurjopay_gateway && !$uddoktapay_gateway ? 'checked' : ''); ?> required>
                                        <div class="payment-content">
                                ...
                                <?php $__currentLoopData = $manual_gateways ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="payment-option-label">
                                        ...
                                        ?>
                                        <input type="radio" name="payment_method" value="manual_<?php echo e($mg->id); ?>" <?php echo e(($manualChecked && $loop->first) ? 'checked' : ''); ?> required>
                                        <div class="payment-content">
                            ...
                            <script>
                                window.RESELLER_MANUAL_GATEWAYS = <?php echo json_encode(($manual_gateways ?? collect())->map(fn ($g) => [
                        ...
                        <div class="checkout-card">
                            ...
                            <div class="card-body-custom p-0">
                                ...
                                <?php $__currentLoopData = Cart::instance('shopping')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="checkout-item">
                                        ...
                                        <img src="<?php echo e(asset($value->options->image ?? 'public/uploads/default.webp')); ?>" class="checkout-pro-img" alt="<?php echo e($value->name); ?>">
                                        ...
                                        <div class="checkout-pro-info flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="fw-bold text-dark">
                                                    <?php if($itemResellerPrice): ?>
                                                        <div class="text-primary">৳<?php echo e(number_format($itemResellerPrice * $value->qty, 0)); ?></div>
                                                        <small class="text-muted" style="font-size: 11px;">রিসেলার প্রাইস</small>
                                                    <?php else: ?>
                                                        ৳<?php echo e(number_format($value->price * $value->qty, 0)); ?>
                            ...
                            <div class="reseller-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text-muted d-block mt-2">
                                        ...
                                        রিসেলার প্রাইস: ৳<?php echo e(number_format($totalResellerPrice, 2)); ?>
                            ...
                            <div class="summary-totals">
                                <div class="total-row">
                                    ...
                                    <span id="totalResellerPriceDisplay">৳<?php echo e(number_format($totalResellerPrice, 2)); ?></span>
                                </div>
                                <div class="total-row">
                                    ...
                                    <span id="shippingAmount">
                                        ...
                                        ?>
                                        ৳<?php echo e(number_format($displayShipping, 2)); ?>
                                ...
                                <div class="total-row" style="background: #fff8e1; padding: 12px; border-left: 4px solid #ffc107;">
                                    ...
                                    <span id="advanceAmountDisplay" style="color: #f59e0b; font-weight: 700;">৳<?php echo e(number_format($advanceAmount, 2)); ?></span>
                                </div>
                                <div class="total-row" style="color: #6b7280; font-size: 0.9em;">
                                    <span>অবশিষ্ট পরিশোধ</span> 
                                    <span id="dueAmountDisplay">৳<?php echo e(number_format($dueAmount, 2)); ?></span>
                                </div>
                                <?php endif; ?>
                                
                                <div class="total-row final">
                                    <span><strong><?php if($hasAdvance): ?> এখন পেমেন্ট করতে হবে <?php else: ?> কাস্টমার পেমেন্ট <?php endif; ?></strong></span> 
                                    <span id="customerPayableAmount" style="font-size: 1.2em; font-weight: 700;">
                                        <?php if($hasAdvance): ?>
                                            ৳<?php echo e(number_format($advanceAmount, 2)); ?>
        ...
        <?php if(!empty($__showResellerCheckoutOtpModal)): ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" id="reseller_checkout_otp_modal_field" class="form-control form-control-lg text-center" maxlength="6" inputmode="numeric" autocomplete="one-time-code" placeholder="● ● ● ● ● ●" style="letter-spacing: 0.35em;" value="<?php echo e(old('checkout_otp')); ?>">
        ...
        <form id="reseller_checkout_otp_resend_form" action="<?php echo e(route('reseller.checkout.resend_otp')); ?>" method="POST" style="display:none;">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<script>
    var totalResellerPrice = <?php echo e($totalResellerPrice); ?>;
    var advanceAmount = <?php echo e($advanceAmount ?? 0); ?>;
    var hasAdvance = <?php echo e($hasAdvance ? 'true' : 'false'); ?>;
    var hasAllFreeDelivery = <?php echo json_encode($hasAllFreeDelivery ?? false, 15, 512) ?>;
    ...
    function resellerApplyShippingUi() {
        ...
        if (!isFd) {
            ...
            if (did) $.get('<?php echo e(route("shipping.charge")); ?>', { id: did }).always(function () { updateCalculations(); });
        } else {
            $.get('<?php echo e(route("shipping.charge")); ?>', { id: 'free_delivery' }).always(function () { updateCalculations(); });
        }
    }
    ...
    $(document).ready(function() {
        ...
        if (hasAllFreeDelivery) {
            $.get('<?php echo e(route("shipping.charge")); ?>', { id: 'free_delivery' }, function () {
    ...
    $('.checkout-qty .plus').on('click', function() {
        ...
        $("#loading").show();
        $.get("<?php echo e(route('cart.increment')); ?>", { id: rowId }, function() { 
            window.location.reload(); 
        });
    });
    ...
    $('.checkout-qty .minus').on('click', function() {
        var rowId = $(this).closest('.checkout-qty').data('rowid');
        $("#loading").show();
        $.get("<?php echo e(route('cart.decrement')); ?>", { id: rowId }, function() { 
            window.location.reload(); 
        });
    });
...
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\checkout.blade.php ENDPATH**/ ?>