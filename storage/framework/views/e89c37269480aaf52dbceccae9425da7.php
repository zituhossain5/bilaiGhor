...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('roles.store')); ?>" method="POST" data-parsley-validate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($permissionExists && $permissionCount > 0): ?>
                            <div class="row g-3">
                                    ...
                                    <div class="permission-item">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input permission-checkbox" 
                                                   value="<?php echo e($value->id); ?>" id="perm_<?php echo e($value->id); ?>" name="permission[]">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\roles\create.blade.php ENDPATH**/ ?>