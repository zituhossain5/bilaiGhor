...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-4">
                <div>
                    <h4 class="page-title mb-1 text-dark fw-bold">Edit Color: <?php echo e($edit_data->colorName); ?></h4>
                    <p class="text-muted font-size-13 mb-0">Update color details and status.</p>
                </div>
                <div class="page-title-right">
                    <a href="<?php echo e(route('colors.index')); ?>" class="btn btn-light rounded-pill border shadow-sm px-4">
    ...
    <form action="<?php echo e(route('colors.update')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           name="colorName" value="<?php echo e($edit_data->colorName); ?>" id="colorName" required>
...
unset($__errorArgs, $__bag); ?>" 
                                               name="color" value="<?php echo e($edit_data->color); ?>" id="color" required 
                                               onchange="updateColorCode(this.value)">
                                        <span id="colorCode" class="color-code"><?php echo e($edit_data->color); ?></span>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\color\edit.blade.php ENDPATH**/ ?>