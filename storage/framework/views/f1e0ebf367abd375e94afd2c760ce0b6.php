...
<style>
    ...
    .subcat-name { font-weight: 600; color: #343a40; font-size: 14px; }
    .parent-cat { font-size: 12px; font-weight: 500; }
...
<div class="container-fluid">
    ...
    <div class="row mb-3 mt-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('subcategories.create')); ?>" class="btn btn-primary rounded-pill shadow-sm px-4">
                    ...
                    <table id="datatable-buttons" class="table table-hover w-100 dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($value->category): ?>
                                        <span class="badge badge-pill badge-soft-info parent-cat">
                                            <i class="fe-folder me-1"></i> <?php echo e($value->category->name); ?>
                                ...
                                <td>
                                    <span class="subcat-name"><?php echo e($value->subcategoryName); ?></span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('subcategories.edit',$value->id)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fe-edit"></i>
                                        </a>

                                        
                                        <form method="post" action="<?php echo e(route('subcategories.destroy')); ?>" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\subcategory\index.blade.php ENDPATH**/ ?>