...
<?php $__env->startSection('title', 'আমার অর্ডারসমূহ'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="stats-card">
        ...
        <div>
            ...
            <small class="text-muted">মোট অর্ডার: <strong><?php echo e($orders->total()); ?></strong> টি</small>
        </div>
        <div class="ms-auto">
             <form method="GET" class="d-flex align-items-center gap-2">
                <input type="text" name="search" class="form-control form-control-sm" placeholder="অর্ডার আইডি বা ফোন..." value="<?php echo e(request('search')); ?>">
                ...
                <div class="order-header">
                    <div class="d-flex align-items-center gap-3">
                        <div class="d-flex flex-column">
                            ...
                            <span class="fw-bold text-dark fs-5">#<?php echo e($order->invoice_id ?? $order->id); ?></span>
                        </div>
                        <span class="text-muted small">|</span>
                        <div class="d-flex flex-column">
                            <span class="text-secondary small fw-bold text-uppercase">তারিখ</span>
                            <span class="text-dark small"><i class="far fa-clock me-1"></i> <?php echo e($order->created_at->format('d M, Y h:i A')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="badge-soft <?php echo e($statusClass); ?>">
                            <?php echo e($order->status->name ?? 'Pending'); ?>
                        ...
                        <?php if(!empty($trackingId)): ?>
                            ...
                            ?>
                            <?php if($ct === 'pathao'): ?>
                                <a href="https://merchant.pathao.com/public-tracking?consignment_id=<?php echo e($trackingId); ?>" target="_blank" rel="noopener noreferrer" class="btn-track">
                                    <i class="fas fa-location-arrow"></i>
                                    <span>লাইভ ট্র্যাকিং</span>
                                </a>
                            <?php elseif($ct === 'steadfast' || (!$courierType && $trackingId)): ?>
                                <?php
                                ...
                                ?>
                                <a href="<?php echo e($sfHref); ?>" target="_blank" rel="noopener noreferrer" class="btn-track">
                                    <i class="fas fa-location-arrow"></i>
                                    <span>লাইভ ট্র্যাকিং</span>
                                </a>
                            <?php elseif($ct === 'redx'): ?>
                                <a href="https://redx.com.bd/track/<?php echo e($trackingId); ?>" target="_blank" rel="noopener noreferrer" class="btn-track">
                                    <i class="fas fa-location-arrow"></i>
                                    <span>লাইভ ট্র্যাকিং</span>
                                </a>
                            <?php endif; ?>
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-md-5 border-end-md">
                            <div class="customer-info">
                                <div class="customer-avatar">
                                    <?php echo e(substr($order->customer->name ?? 'G', 0, 1)); ?>

                                </div>
                                <div>
                                    <h6 class="fw-bold text-dark mb-1"><?php echo e($order->customer->name ?? 'Guest Customer'); ?></h6>
                                    <p class="text-muted mb-1 small"><i class="fas fa-phone-alt me-1 text-secondary"></i> <?php echo e($order->customer->phone ?? 'N/A'); ?></p>
                                    <p class="text-muted mb-0 small">
                                        <i class="fas fa-map-marker-alt me-1 text-secondary"></i> 
                                        <?php if($order->shipping && $order->shipping->address): ?>
                                            <?php echo e(Str::limit($order->shipping->address, 50)); ?>
                                ...
                                <div class="product-list">
                                    <?php $__currentLoopData = $order->orderdetails->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="product-item d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0">
                                                <?php if($productImage): ?>
                                                    <?php if($productSlug): ?>
                                                        <a href="<?php echo e(route('reseller.products.show', $productSlug)); ?>" class="text-decoration-none">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <?php if($productSlug): ?>
                                                            <a href="<?php echo e(route('reseller.products.show', $productSlug)); ?>" 
                                                               ...
                                                               onmouseout="this.style.color='#1f2937'">
                                                                <?php echo e(Str::limit($detail->product_name, 22)); ?>

                                                            </a>
                                                        <?php else: ?>
                                                            <span class="text-dark fw-semibold d-block" style="font-size: 0.85rem; line-height: 1.3;"><?php echo e(Str::limit($detail->product_name, 22)); ?></span>
                                                        <?php endif; ?>
                                                        <span class="text-muted small">x <?php echo e($detail->qty); ?></span>
                                                    </div>
                                                    <span class="fw-bold text-secondary" style="font-size: 0.9rem;">৳<?php echo e(number_format($detail->sale_price * $detail->qty)); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php if($order->orderdetails->count() > 3): ?>
                                        <div class="text-center mt-2 pt-2 border-top">
                                            <small class="text-primary cursor-pointer">+ আরও <?php echo e($order->orderdetails->count() - 3); ?> টি পণ্য</small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="col-md-3 text-md-end">
                            <div class="mb-3">
                                ...
                                <h5 class="fw-bold text-dark mb-0">৳<?php echo e(number_format($order->customer_payable_amount ?? 0)); ?></h5>
                            </div>
                            
                            <div>
                                <div class="profit-pill">
                                    <i class="fas fa-coins"></i> লাভ: ৳<?php echo e(number_format($order->reseller_profit ?? 0)); ?>
...
<div class="d-flex justify-content-center mt-5 mb-4">
    ...
    <div class="pagination-pill">
        ...
        <?php else: ?>
            <a href="<?php echo e($orders->previousPageUrl()); ?>" class="page-link-circle" title="Previous">
                <i class="fas fa-chevron-left" style="font-size: 12px;"></i>
            </a>
        <?php endif; ?>
        ...
        <?php $__currentLoopData = range(1, $orders->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($i >= $orders->currentPage() - 2 && $i <= $orders->currentPage() + 2): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($orders->url($i)); ?>" class="page-link-circle"><?php echo e($i); ?></a>
                <?php endif; ?>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($orders->hasMorePages()): ?>
            <a href="<?php echo e($orders->nextPageUrl()); ?>" class="page-link-circle" title="Next">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\reseller\orders.blade.php ENDPATH**/ ?>