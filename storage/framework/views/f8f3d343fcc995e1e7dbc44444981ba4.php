...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('subcategories.store')); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>" 
                                           name="subcategoryName" value="<?php echo e(old('subcategoryName')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                   name="meta_title" value="<?php echo e(old('meta_title')); ?>" placeholder="SEO optimized title">
...
unset($__errorArgs, $__bag); ?>"
                                      name="meta_description"><?php echo e(old('meta_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <textarea class="summernote form-control <?php $__errorArgs = ['full_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      name="full_description"><?php echo e(old('full_description')); ?></textarea>
                            <small class="text-muted">Shown in accordion below the product grid on the subcategory page.</small>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\subcategory\create.blade.php ENDPATH**/ ?>