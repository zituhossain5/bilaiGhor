...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Track company spending for: <strong><?php echo e($label ?? 'Today'); ?></strong></p>
        </div>
    </div>

    
    <div class="filter-card">
        <form method="GET" action="<?php echo e(route('admin.reports.expenses')); ?>" id="expense-filter-form">
        ...
        <div class="col-md-4">
            <div class="expense-card">
                <div>
                    ...
                    <h2 class="expense-amount">৳<?php echo e(number_format($totalExpense ?? 0, 2)); ?></h2>
                </div>
    ...
    <div id="expense-table-wrapper">
        <div class="card card-modern">
                ...
                <table class="table table-modern mb-0">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-dark"><?php echo e($e->title); ?></td>
                            <td><span class="badge bg-light text-dark border"><?php echo e($e->category ?? 'General'); ?></span></td>
                            <td class="text-end fw-bold text-danger">৳<?php echo e(number_format($e->amount ?? 0, 2)); ?></td>
                            <td class="text-muted small fst-italic"><?php echo e(Str::limit($e->note, 50) ?? '-'); ?></td>
                        </tr>
            ...
            <div class="p-4 border-top d-flex justify-content-between align-items-center">
                <small class="text-muted">Showing <?php echo e($expenses->firstItem()); ?> to <?php echo e($expenses->lastItem()); ?> of <?php echo e($expenses->total()); ?> entries</small>
                <div><?php echo e($expenses->links('pagination::bootstrap-4')); ?></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function loadExpenses(query) {
        fetch("<?php echo e(route('admin.reports.expenses')); ?>?" + query, {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\reports\expenses.blade.php ENDPATH**/ ?>