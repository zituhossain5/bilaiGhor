        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between py-3">
                ...
                <div class="page-title-right gap-2 d-flex">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-secondary rounded-pill shadow-sm">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted mb-0">
                                <?php if($product->vendor): ?>
                                    <span class="badge badge-soft-primary"><i class="fe-user me-1"></i><?php echo e($product->vendor->shop_name ?? 'Vendor #' . $product->vendor_id); ?></span>
                                <?php else: ?>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <h4 class="mb-0 <?php echo e($product->stock <= 5 ? 'text-danger' : 'text-success'); ?>">
                                    <?php echo e($product->stock); ?> <small class="font-size-14 text-muted"><?php echo e($product->pro_unit ?? 'pcs'); ?></small>
                                </h4>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-nowrap table-bordered mb-0">
                            <tbody>
                                <tr>
                                    <th>Product Code</th>
                                    <td>#<?php echo e($product->product_code ?? 'N/A'); ?></td>
                                </tr>
                                <tr>
                                    <th>Category</th>
                                    <td>
                                        ...
                                        <?php if($product->subcategory): ?>
                                            <i class="fe-chevron-right mx-1 font-size-10"></i> <?php echo e($product->subcategory->subcategoryName ?? $product->subcategory->name); ?>

                                        <?php endif; ?>
                                        <?php if($product->childcategory): ?>
                                            <i class="fe-chevron-right mx-1 font-size-10"></i> <?php echo e($product->childcategory->childcategoryName ?? $product->childcategory->name); ?>
                                ...
                                <?php endif; ?>
                                <?php if($product->is_wholesale && $product->wholesalePrices && $product->wholesalePrices->count() > 0): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $product->wholesalePrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($tier->min_quantity); ?></td>
                                                        <td><?php echo e($tier->max_quantity ?? 'Unlimited'); ?></td>
                                                        <td>৳<?php echo e(number_format($tier->wholesale_price, 2)); ?></td>
                                                        <td><?php echo e($tier->stock ?? 0); ?></td>
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
                                ...
                                <?php endif; ?>
                                <?php if($product->variantPrices && $product->variantPrices->count() > 0): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $product->variantPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($variant->color ? ($variant->color->colorName ?? $variant->color->name) : 'N/A'); ?></td>
                                                        <td><?php echo e($variant->size ? ($variant->size->sizeName ?? $variant->size->name) : 'N/A'); ?></td>
                                                        <td>৳<?php echo e(number_format($variant->price, 2)); ?></td>
                                                        <td><?php echo e($variant->stock ?? 0); ?></td>
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
                    ...
                    <?php
                        $showVideoType = $product->pro_video_type ?? ($product->pro_video ? 'youtube' : null);
                    ?>
                    <?php if($showVideoType === 'youtube' && $product->pro_video): ?>
                    <div class="mt-4">
                        <h5 class="font-size-15 mb-2">Product Video</h5>
                        <a href="https://www.youtube.com/watch?v=<?php echo e($product->pro_video); ?>" target="_blank"
                           class="btn btn-outline-danger btn-sm">
                            <i class="fa fa-youtube-play me-1"></i> YouTube-এ দেখুন
                        </a>
                        <div class="mt-2">
                            <iframe width="100%" height="250"
                                src="https://www.youtube.com/embed/<?php echo e($product->pro_video); ?>"
                                frameborder="0" allowfullscreen
                                style="border-radius:8px;"></iframe>
                        </div>
                    </div>
                    <?php elseif($showVideoType === 'upload' && $product->pro_video_path): ?>
                    <div class="mt-4">
                        ...
                        <video width="100%" height="250" controls
                            ...
                            <source src="<?php echo e(asset($product->pro_video_path)); ?>" type="video/mp4">
                            <source src="<?php echo e(asset($product->pro_video_path)); ?>" type="video/webm">
                        </video>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\product\show.blade.php ENDPATH**/ ?>