            ...
            <div class="col-lg-8">
                <div class="op-card">
                    ...
                    <div class="op-card-body">
                        ...
                        <input type="hidden" id="adm_process_division_hidden" name="division_id" value="<?php echo e($admSelDiv); ?>">
                        <input type="hidden" id="adm_process_upazila_hidden" name="upazila_id" value="<?php echo e($admSelUp); ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-5 op-input-group">
                                ...
                                <input type="text" id="adm_process_postcode" class="form-control" name="post_code"
                                       maxlength="20" placeholder="১xxxx" value="<?php echo e($admProcPostCode); ?>">
                            </div>
                            <div class="col-md-7 op-input-group">
                                ...
                                <select name="district_id" id="adm_process_district" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $processDistricts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($district->id); ?>" data-division="<?php echo e($district->division_id); ?>"
                                            <?php echo e($admSelDist === (int) $district->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-12 op-input-group">
                                ...
                                <select name="zone_id" id="adm_process_zone" class="form-select" required <?php echo e($admSelDist ? '' : 'disabled'); ?>>
                                    <option value=""><?php echo e($admSelDist ? 'জোন লোড হচ্ছে...' : 'আগে জেলা সিলেক্ট করুন'); ?></option>
                                </select>
                            </div>
                        </div>
...
(function () {
    ...
    var procZonesUrl = '<?php echo e(route("customer.delivery_zones")); ?>';
    var procSelectedZone = <?php echo e($admProcZone); ?>;
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bilaiGhor\resources\views\backEnd\order\process.blade.php ENDPATH**/ ?>